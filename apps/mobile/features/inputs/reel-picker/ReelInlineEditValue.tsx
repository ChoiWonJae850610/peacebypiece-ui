...
const styles = StyleSheet.create({
  ...
  active: { backgroundColor: "#fff9ed", borderBottomColor: WAFL_THEME.color.editActive, borderBottomWidth: WAFL_THEME.border.hairline, borderRadius: 5, minHeight: 36, minWidth: 0, paddingHorizontal: WAFL_THEME.spacing.xs, paddingVertical: 3 },
  valueButton: { alignItems: "center", flexDirection: "row", gap: 7, minHeight: 30, minWidth: 0 },
