...
const READINESS_SECTION_BY_CODE: Readonly<Record<string, ReadinessDestinationIntent>> = {
  ...
  MATERIAL_MISSING_WARNING: "fabric",
  ACCESSORY_MISSING_WARNING: "accessory",
  MATERIAL_OPTIONAL_DETAIL_WARNING: "materials",
  ACCESSORY_CONFIRM_LATER: "accessory",
  BASIC_PROCESS_REQUIRED: "production",
  BASIC_PROCESS_ORDER_REQUIRED: "production",
