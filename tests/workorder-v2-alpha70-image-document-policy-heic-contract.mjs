...
assert.match(imageGallery, /props\.drawingRendererPocEnabled \? "SVG Performance PoC" : "스케치"/u);
assert.match(imageGallery, /disabled=\{!props\.drawingRendererPocEnabled\}/u);
