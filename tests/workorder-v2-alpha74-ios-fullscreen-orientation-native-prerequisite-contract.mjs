...
assert.match(appJson.expo.extra.appVersion, /^2\.0\.0-alpha\.(?:74|75|76|77|78|79|80)$/u);
...
assert.match(read("lib/constants/version.ts"), /2\.0\.0-alpha\.(?:74|75|76|77|78|79|80)/u);
