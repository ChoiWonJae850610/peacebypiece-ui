...
assert.match(mobile,/InlineEditableValue/);assert.match(mobile,/ExpandableInlineNote/);assert.doesNotMatch(mobile,/compactInstructionInput/);assert.doesNotMatch(mobile,/보내는 시점|공장 전달수량|별도 비고/);
