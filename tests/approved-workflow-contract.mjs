...
const requiredVerifyTokens = [
  ...
  "workorder v2 alpha.51 material soft-delete restore lifecycle contract",
  "tests/workorder-v2-alpha51-material-soft-delete-restore-contract.mjs",
  "workorder v2 alpha.52 mobile work-order list contract",
  "tests/workorder-v2-alpha52-mobile-work-order-list-contract.mjs",
  "workorder v2 alpha.52 mobile overview inline editing contract",
  "tests/workorder-v2-alpha52-mobile-overview-inline-editing-contract.mjs",
  "workorder v2 alpha.52 mobile material inline editing contract",
  "tests/workorder-v2-alpha52-mobile-material-inline-editing-contract.mjs",
  "workorder v2 alpha.52 mobile inline focus contract",
  "tests/workorder-v2-alpha52-mobile-inline-focus-contract.mjs",
  "workorder v2 alpha.52 mobile inline visibility and date picker contract",
  "tests/workorder-v2-alpha52-mobile-inline-visibility-date-picker-contract.mjs",
  "workorder v2 alpha.52 mobile numeric draft contract",
