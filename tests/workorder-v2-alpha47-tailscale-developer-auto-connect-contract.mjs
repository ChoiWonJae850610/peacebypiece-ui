...
assert.equal(json("apps/mobile/package.json").version, "2.0.0-alpha.47");
assert.equal(json("apps/mobile/package-lock.json").version, "2.0.0-alpha.47");
assert.equal(json("apps/mobile/package-lock.json").packages[""].version, "2.0.0-alpha.47");
const appJson = json("apps/mobile/app.json");
assert.equal(appJson.expo.version, "2.0.0");
assert.equal(appJson.expo.extra.appVersion, "2.0.0-alpha.47");
