...
assert.equal(json("apps/mobile/package.json").version, "2.0.0-alpha.50");
assert.equal(json("apps/mobile/package-lock.json").version, "2.0.0-alpha.50");
assert.equal(json("apps/mobile/package-lock.json").packages[""].version, "2.0.0-alpha.50");
