...
assert.match(list, />레시피</);
assert.match(list, /레시피 목록 새로고침/);
for (const field of ["representativeThumbnail", "productName", "getWorkOrderWorkflowPresentation", "totalQuantity", "dueDate"]) assert.match(list, new RegExp(field));
