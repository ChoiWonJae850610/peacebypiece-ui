...
assert.match(documentRenderer, /<SectionHeading Icon=\{Palette\} numberLabel="03" title="색상·사이즈 수량"/);
assert.match(documentRenderer, /<td className=\{styles\.strongCell\}>\{color\.displayName\}<\/td>/);
assert.doesNotMatch(documentRenderer, /<i style=\{\{ backgroundColor|fill=\{color\.hexValue/);
