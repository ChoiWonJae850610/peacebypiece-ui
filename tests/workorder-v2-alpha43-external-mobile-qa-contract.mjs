...
assert.deepEqual(
  ...
  ["expo-router", "./plugins/withWaflNativeOrientationPolicy", "@config-plugins/react-native-blob-util", "@config-plugins/react-native-pdf", "expo-image-picker", "expo-document-picker"],
);
