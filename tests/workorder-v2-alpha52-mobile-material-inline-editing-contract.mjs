...
assert.match(app, /if \(field === "orderQuantity"\) continue/);
assert.match(materials, /line\.lifecycle === "active"/);
assert.match(materials, /line\.status === "editing"/);
assert.match(materials, /!line\.locked/);
assert.match(app, /line\.lifecycle !== "active"/);
assert.match(app, /line\.locked/);
assert.match(app, /await patchWorkOrderMaterial/);
assert.match(app, /await createWorkOrderMaterial/);
