...
assert.ok([ALPHA78_FINALIZED_APP_VERSION, "2.0.0-alpha.79", "2.0.0-alpha.80"].includes(version));
...
assert.ok([ALPHA78_FINALIZED_APP_VERSION, "2.0.0-alpha.79", "2.0.0-alpha.80"].includes(appConfig.expo.extra.appVersion));
