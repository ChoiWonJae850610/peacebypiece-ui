...
assert.match(quick, /function QuickNestedPressable[\s\S]*useWaflSheetFocusLifecycle/u, "nested triggers end the parent focus lifecycle before transition");
assert.doesNotMatch(quick, /matchesWaflNestedSheetFocusIntent|requestAnimationFrame|focusIntent/u, "A73C removes feature-local nested-return focus owners");
