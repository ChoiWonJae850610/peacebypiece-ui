...
for (const semantic of ["SIZE_ALPHA_PRESETS", "SIZE_NUMERIC_PRESETS", "COLOR_PALETTE_PRESETS", "CUSTOM_COLOR_GROUPS", "WaflOptionGrid", "onApplySelectionBatch", "applyBatch"]) {
