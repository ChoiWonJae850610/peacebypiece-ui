...
assertIncludes("lib/constants/version.ts", 'APP_VERSION = "0.24.29"');
assertIncludes("lib/internal/roadmap/index.ts", 'currentWorkVersion: "0.24.29"');
assertIncludes("lib/internal/roadmap/index.ts", 'nextWorkVersion: "0.24.30"');
assertIncludes("docs/codex-current-state.md", "Current version: `0.24.29`");
assertIncludes("docs/productization-roadmap.md", "Active baseline: `0.24.29`");
...
assertIncludes("lib/internal/roadmap/roadmap-0.24.29.ts", "Integrated Productization Checkpoint");

for (const file of ["README.md", "docs/README.md", "docs/codex-current-state.md", "docs/productization-roadmap.md"]) {
  assertNotIncludes(file, "?꾩옱");
  assertNotIncludes(file, "理쒖쥌");
  assertNotIncludes(file, "踰꾩쟾");
}
