...
for (const token of ["snapToInterval={ITEM_HEIGHT}", "VISIBLE_ROWS = 5", "숫자 직접 입력", "numberReel", "intervalReel", "unitOnlyReel", "<WaflInputSheet"]) assert.ok(sheet.includes(token), `reel sheet missing ${token}`);
