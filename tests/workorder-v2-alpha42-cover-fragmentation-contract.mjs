...
// Alpha.70 trims the main cover block to keep long business text inside the
// same portrait-page fragmentation safety boundary.
assert.match(css, /\.coverMain \{ height: 140mm;/);
