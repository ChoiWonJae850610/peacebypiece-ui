...
for (const item of ["BEGIN READ ONLY","WAFL_DB_AUDIT_APPROVED","Forbidden non-read-only SQL token detected","mode === 'constraints'","totalReportedIssues > 0","mode === 'reconciliation'","process.exitCode = 0"]) {
