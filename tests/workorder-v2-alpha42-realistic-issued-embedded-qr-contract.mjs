...
assert.ok(new Set(["2.0.0-alpha.41", "2.0.0-alpha.42", "2.0.0-alpha.43", "2.0.0-alpha.44", "2.0.0-alpha.45", "2.0.0-alpha.46"]).has(version), "alpha.42 checkpoint/final version invalid");
