...
VALUES
  ('test-a-wo-draft-designer', 'test-company-a', 'TEST A 고객사', 'TEST A 작성중 디자이너 담당', 'draft', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 작성중 디자이너 담당', 'TEST A 작성중 디자이너 담당', '2026 SS', 'normal', 'TEST A 디자이너', 'test-a-designer', 'test-a-designer', 'designer', '2026-06-10', 100, true, 'active'),
  ('test-a-wo-review-requested', 'test-company-a', 'TEST A 고객사', 'TEST A 검토요청 디자이너 담당', 'review_requested', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 검토요청 디자이너 담당', 'TEST A 검토요청 디자이너 담당', '2026 SS', 'normal', 'TEST A 디자이너', 'test-a-designer', 'test-a-designer', 'designer', '2026-06-12', 120, true, 'active'),
  ('test-a-wo-review-completed', 'test-company-a', 'TEST A 고객사', 'TEST A 검토완료 디자이너 담당', 'review_completed', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 검토완료 디자이너 담당', 'TEST A 검토완료 디자이너 담당', '2026 SS', 'high', 'TEST A 디자이너', 'test-a-designer', 'test-a-admin', 'admin', '2026-06-15', 150, true, 'active'),
  ('test-a-wo-inspection', 'test-company-a', 'TEST A 고객사', 'TEST A 검수중 검수담당 담당', 'inspection', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 검수중 검수담당 담당', 'TEST A 검수중 검수담당 담당', '2026 SS', 'normal', 'TEST A 검수담당', 'test-a-inspector', 'test-a-admin', 'admin', '2026-06-18', 80, true, 'active'),
  ('test-a-wo-completed', 'test-company-a', 'TEST A 고객사', 'TEST A 완료 검수담당 담당', 'completed', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 완료 검수담당 담당', 'TEST A 완료 검수담당 담당', '2026 SS', 'low', 'TEST A 검수담당', 'test-a-inspector', 'test-a-admin', 'admin', '2026-06-20', 90, true, 'active'),
  ('test-a-wo-rejected', 'test-company-a', 'TEST A 고객사', 'TEST A 반려 디자이너 담당', 'rejected', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 반려 디자이너 담당', 'TEST A 반려 디자이너 담당', '2026 SS', 'normal', 'TEST A 디자이너', 'test-a-designer', 'test-a-admin', 'admin', '2026-06-21', 70, true, 'active'),
  ('test-a-wo-material-draft', 'test-company-a', 'TEST A 고객사', 'TEST A 작성중 자재담당 담당', 'draft', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 작성중 자재담당 담당', 'TEST A 작성중 자재담당 담당', '2026 SS', 'normal', 'TEST A 자재담당', 'test-a-material', 'test-a-material', 'inventory_manager', '2026-06-22', 110, true, 'active'),
  ('test-a-wo-trashed', 'test-company-a', 'TEST A 고객사', 'TEST A 휴지통 작업지시서', 'draft', 'new', 'test-a-cat-outer', 'test-a-cat-tshirt', 'test-a-cat-short', '상의', '티셔츠', '반팔', 'TEST A 휴지통 작업지시서', 'TEST A 휴지통 작업지시서', '2026 SS', 'normal', 'TEST A 디자이너', 'test-a-designer', 'test-a-designer', 'designer', '2026-06-25', 50, false, 'trashed'),
  ('test-b-wo-draft-designer', 'test-company-b', 'TEST B 고객사', 'TEST B 작성중 디자이너 담당', 'draft', 'new', 'test-b-cat-outer', 'test-b-cat-shirt', NULL, '상의', '셔츠', NULL, 'TEST B 작성중 디자이너 담당', 'TEST B 작성중 디자이너 담당', '2026 SS', 'normal', 'TEST B 디자이너', 'test-b-designer', 'test-b-designer', 'designer', '2026-06-10', 60, true, 'active');
