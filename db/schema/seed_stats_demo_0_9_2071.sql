...
INSERT INTO attachments (id, company_id, company_name, order_id, type, storage_key, original_name, mime_type, size_bytes, author_id, is_primary, thumbnail_key, is_active, deleted_at, deleted_by, delete_reason, purge_after_at, created_at, updated_at)
VALUES
  ('stats-demo-attachment-001', 'company-sample-customer', '샘플 고객사', 'stats-demo-spec-001', 'design', 'workorders/stats-demo-spec-001/design/stats-demo-attachment-001.png', '반팔_디자인.png', 'image/png', 734003, 'user-sample-designer', true, 'workorders/stats-demo-spec-001/design/stats-demo-attachment-001-thumb.png', true, NULL, NULL, NULL, NULL, now() - interval '25 days', now() - interval '2 days'),
  ('stats-demo-attachment-002', 'company-sample-customer', '샘플 고객사', 'stats-demo-spec-002', 'file', 'workorders/stats-demo-spec-002/attachments/stats-demo-attachment-002.pdf', '작업지시서_참고.pdf', 'application/pdf', 1258291, 'user-sample-admin', false, NULL, true, NULL, NULL, NULL, NULL, now() - interval '18 days', now() - interval '1 days'),
  ('stats-demo-attachment-003', 'company-sample-customer', '샘플 고객사', 'stats-demo-spec-003', 'design', 'workorders/stats-demo-spec-003/design/stats-demo-attachment-003.jpg', '슬랙스_스케치.jpg', 'image/jpeg', 943718, 'user-sample-designer', true, 'workorders/stats-demo-spec-003/design/stats-demo-attachment-003-thumb.jpg', true, NULL, NULL, NULL, NULL, now() - interval '15 days', now() - interval '3 days'),
  ('stats-demo-attachment-004', 'company-sample-customer', '샘플 고객사', 'stats-demo-spec-004', 'file', 'workorders/stats-demo-spec-004/attachments/stats-demo-attachment-004.xlsx', '자켓_사이즈표.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 524288, 'user-sample-admin', false, NULL, true, NULL, NULL, NULL, NULL, now() - interval '12 days', now() - interval '2 days'),
  ('stats-demo-attachment-005', 'company-sample-customer', '샘플 고객사', 'stats-demo-spec-005', 'design', 'workorders/stats-demo-spec-005/design/stats-demo-attachment-005.png', '리오더_수정디자인.png', 'image/png', 838860, 'user-sample-designer', true, 'workorders/stats-demo-spec-005/design/stats-demo-attachment-005-thumb.png', true, NULL, NULL, NULL, NULL, now() - interval '9 days', now() - interval '1 days'),
  ('stats-demo-attachment-006', 'company-sample-customer', '샘플 고객사', 'stats-demo-spec-010', 'file', 'workorders/stats-demo-spec-010/attachments/stats-demo-attachment-006.pdf', '삭제된_참고자료.pdf', 'application/pdf', 629145, 'user-sample-admin', false, NULL, false, now() - interval '10 days', 'user-sample-admin', '통계 휴지통 확인용', now() + interval '20 days', now() - interval '20 days', now() - interval '10 days');
