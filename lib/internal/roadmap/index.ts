...
export const PRODUCTIZATION_ROADMAP: ProductizationRoadmapSummary = {
  ...
  productizationProgressPercent: 82,
  currentWorkVersion: "0.24.15",
  nextWorkVersion: "0.24.16",
  canonicalPolicy:
    "새 버전 기능 작업 전에는 lib/internal/roadmap의 canonical 상세 명세와 docs/codex-current-state.md를 먼저 읽는다. 0.24.15 이후 제품화 작업은 docs/audits/productization-audit-report-0.24.15.md와 docs/productization-backlog.md의 PB 우선순위를 함께 따른다. /roadmap은 사용자와 ChatGPT/Codex가 함께 보는 조회 전용 개발 기준판이며, 화면에서 편집·추가·삭제·저장 기능을 제공하지 않는다.",
