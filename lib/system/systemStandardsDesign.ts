...
export const SYSTEM_STANDARD_DESIGN_TABS: SystemStandardDesignTab[] = [
  {
    ...
    notes: [
      ...
      "향후 system_unit_standards와 company_enabled_unit_standards 계층으로 분리할 수 있습니다.",
    ],
  },
  {
    ...
    notes: [
      ...
      "향후 system_outsourcing_process_standards와 company_enabled_process_standards로 분리할 수 있습니다.",
    ],
  },
  {
    ...
    notes: [
      ...
      "향후 template_product_type_categories와 company_product_type_categories를 분리할 수 있습니다.",
    ],
  },
];
...
export const SYSTEM_STANDARDS_POLICY_NOTES = [
  ...
  "이번 화면은 설계 화면입니다. 실제 CRUD, DB schema, 고객사별 사용 여부 저장은 후속 버전에서 분리합니다.",
] as const;
