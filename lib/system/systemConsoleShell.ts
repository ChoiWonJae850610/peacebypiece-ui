...
export const SYSTEM_CONSOLE_HERO_OPERATION_CARDS: SystemConsoleNavigationCard[] = [
  ...
  },
  {
    id: "account-requests",
    label: "계정 요청 검토",
    description: "회사 정보 변경과 계정 비활성화 요청을 system-admin 기준으로 검토합니다.",
...
export const SYSTEM_CONSOLE_CUSTOMER_OPERATIONS_NAVIGATION: SystemConsoleNavigationCard[] = [
  {
    id: "signup-applications",
    label: "가입 신청 검토",
    description: "공개 가입 신청의 제출, 검토 중, 보완 요청, 반려 상태를 system-admin 기준으로 확인합니다.",
    href: "/system/signup-applications",
    statusLabel: "0.24.26",
    tone: "primary",
  },
  {
...
export const SYSTEM_CONSOLE_PLATFORM_OPERATIONS_NAVIGATION: SystemConsoleNavigationCard[] = [
  ...
  },
  {
    id: "category-rules",
    label: "카테고리 규칙",
    description: "작업지시서 품목 기반 대분류/품목/브랜드 형태 추천 규칙과 통계 분류 기준을 관리합니다.",
...
export const SYSTEM_CONSOLE_NAVIGATION_SECTIONS: SystemConsoleNavigationSection[] = [
  ...
  },
  {
    id: "billing-operations",
    title: "요금/결제/증빙",
    description: "카드결제 중립 운영에 필요한 요금제, 결제수단, 결제내역, 실패/미납, 환불, 증빙 메뉴를 분리합니다.",
