...
export const SAMPLE_PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    contactName: "정다솜",
    phone: "01091024458",
    email: "colorup@outsourcing.kr",
    outsourcingProcessTypes: ["printing", "finishing"],
    supportedProcesses: ["printing", "finishing"],
    memo: "전사, 실크스크린 외주처",
  ...
  },
  {
    ...
    contactName: "오상민",
    phone: "01055882011",
    email: "dongin@partner.kr",
    outsourcingProcessTypes: ["cutting", "washing"],
    supportedProcesses: ["cutting", "washing"],
    memo: "재가동 검토중",
