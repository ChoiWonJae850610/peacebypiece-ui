...
export function buildSidePanelProps({
  ...
  return {
    ...
    attachmentSections: buildAttachmentPanelSections({
      ...
      memoTitle: i18n.workorder.ui.attachmentPanel.memoTitle,
      memoEmptyText: i18n.workorder.ui.attachmentPanel.memoEmpty,
      memoAddButtonLabel: i18n.workorder.ui.attachmentPanel.memoAddButton,
      designAttachments,
      officialAttachments,
      memoAttachments,
      getAttachmentPermissions,
