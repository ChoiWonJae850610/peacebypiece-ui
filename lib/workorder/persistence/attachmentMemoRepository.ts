...
export type AttachmentMemoWritableRepository = AttachmentMemoRepository & {
  ...
  softDeleteAttachment: (input: { attachmentId: string; deletedBy?: string | null; deleteReason?: string | null; trashRetentionDays?: number | null }) => Promise<WorkOrderAttachmentDbRecord | null>;
