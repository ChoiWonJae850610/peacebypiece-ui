...
const PROFILE_DEFINITIONS = Object.freeze([
  ...
  [P.ALPHA65_CURRENT, A.ALPHA65_CURRENT, "WAFL_EXTERNAL_QA_ALPHA65_PRODUCTION_AUTHORING_MUTATION_ENABLED", [C.WORK_ORDER_CREATE, C.BASIC_INFO, C.ASSET_AUTHORING, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_BATCH, C.SIZE_COLOR_HARD_DELETE, C.CUSTOM_OPTIONS, C.MEASUREMENT, C.COMPANY_TEMPLATE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER, C.LEGACY_MATERIAL_ARCHIVE, C.DOCUMENT_R0, C.ADDRESS_SEARCH, C.PRODUCTION_AUTHORING]],
  [P.ALPHA67_CURRENT, A.ALPHA67_CURRENT, "WAFL_EXTERNAL_QA_ALPHA67_NTH_REORDER_MUTATION_ENABLED", [C.WORK_ORDER_CREATE, C.BASIC_INFO, C.ASSET_AUTHORING, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_BATCH, C.SIZE_COLOR_HARD_DELETE, C.CUSTOM_OPTIONS, C.MEASUREMENT, C.COMPANY_TEMPLATE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER, C.LEGACY_MATERIAL_ARCHIVE, C.DOCUMENT_R0, C.ADDRESS_SEARCH, C.PRODUCTION_AUTHORING, C.REORDER_CREATE]],
