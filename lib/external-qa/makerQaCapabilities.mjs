...
export const MAKER_QA_CAPABILITY = Object.freeze({
  ...
  WORK_ORDER_DRAFT_DELETE: "work-order-draft-delete",
  ...
  PRODUCTION_AUTHORING: "production-authoring",
  REORDER_CREATE: "reorder-create",
  DRAWING_AUTHORING: "drawing-authoring",
});
...
export const MAKER_QA_APPROVAL = Object.freeze({
  ...
  ALPHA65_CURRENT: "2.0.0-alpha.65-dev-test-production-authoring-runtime",
  ALPHA67_CURRENT: "2.0.0-alpha.67-dev-test-nth-reorder-runtime",
});
...
export const MAKER_QA_PROFILE = Object.freeze({
  ...
  ALPHA65_CURRENT: "alpha65-current-maker",
  ALPHA67_CURRENT: "alpha67-current-maker",
});
...
const PROFILE_DEFINITIONS = Object.freeze([
  ...
  [P.ALPHA60, A.ALPHA60, "WAFL_EXTERNAL_QA_ALPHA60_DRAFT_CHILD_HARD_DELETE_MUTATION_ENABLED", [C.BASIC_INFO, C.WORK_ORDER_DRAFT_DELETE, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_HARD_DELETE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER, C.LEGACY_MATERIAL_ARCHIVE]],
  ...
  [P.ALPHA62, A.ALPHA62, "WAFL_EXTERNAL_QA_ALPHA62_SIZE_MEASUREMENT_MUTATION_ENABLED", [C.WORK_ORDER_CREATE, C.WORK_ORDER_DRAFT_DELETE, C.BASIC_INFO, C.ASSET_AUTHORING, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_BATCH, C.SIZE_COLOR_HARD_DELETE, C.CUSTOM_OPTIONS, C.MEASUREMENT, C.COMPANY_TEMPLATE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER]],
  [P.ALPHA64_CURRENT, A.ALPHA64_CURRENT, "WAFL_EXTERNAL_QA_ALPHA64_DOCUMENT_R0_MUTATION_ENABLED", [C.WORK_ORDER_CREATE, C.WORK_ORDER_DRAFT_DELETE, C.BASIC_INFO, C.ASSET_AUTHORING, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_BATCH, C.SIZE_COLOR_HARD_DELETE, C.CUSTOM_OPTIONS, C.MEASUREMENT, C.COMPANY_TEMPLATE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER, C.LEGACY_MATERIAL_ARCHIVE, C.DOCUMENT_R0, C.ADDRESS_SEARCH]],
  [P.ALPHA65_CURRENT, A.ALPHA65_CURRENT, "WAFL_EXTERNAL_QA_ALPHA65_PRODUCTION_AUTHORING_MUTATION_ENABLED", [C.WORK_ORDER_CREATE, C.WORK_ORDER_DRAFT_DELETE, C.BASIC_INFO, C.ASSET_AUTHORING, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_BATCH, C.SIZE_COLOR_HARD_DELETE, C.CUSTOM_OPTIONS, C.MEASUREMENT, C.COMPANY_TEMPLATE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER, C.LEGACY_MATERIAL_ARCHIVE, C.DOCUMENT_R0, C.ADDRESS_SEARCH, C.PRODUCTION_AUTHORING]],
  [P.ALPHA67_CURRENT, A.ALPHA67_CURRENT, "WAFL_EXTERNAL_QA_ALPHA67_NTH_REORDER_MUTATION_ENABLED", [C.WORK_ORDER_CREATE, C.WORK_ORDER_DRAFT_DELETE, C.BASIC_INFO, C.ASSET_AUTHORING, C.SIZE_COLOR_STRUCTURE, C.SIZE_COLOR_BATCH, C.SIZE_COLOR_HARD_DELETE, C.CUSTOM_OPTIONS, C.MEASUREMENT, C.COMPANY_TEMPLATE, C.MATERIAL_DRAFT, C.MATERIAL_HARD_DELETE, C.MATERIAL_ORDER, C.LEGACY_MATERIAL_ARCHIVE, C.DOCUMENT_R0, C.ADDRESS_SEARCH, C.PRODUCTION_AUTHORING, C.REORDER_CREATE, C.DRAWING_AUTHORING]],
...
export function resolveMakerQaProfile(env = process.env) {
  ...
  if ((definition.id === P.ALPHA64_CURRENT || definition.id === P.ALPHA65_CURRENT || definition.id === P.ALPHA67_CURRENT) && (
    normalized(env.WAFL_V2_DOCUMENT_VIEWER_ENABLED) !== "1"
    || String(env.WAFL_V2_DOCUMENT_VIEWER_MUTATION_APPROVED ?? "").trim() !== definition.approval
  )) return null;
  return definition;
}
...
export function isCurrentMakerQaProfile(env = process.env) {
  return [P.ALPHA64_CURRENT, P.ALPHA65_CURRENT, P.ALPHA67_CURRENT].includes(resolveMakerQaProfile(env)?.id);
}
