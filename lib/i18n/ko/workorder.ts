export const workorderKo = {
  ...
  ui: {
    ...
    detailGroups: {
      ...
      order: { eyebrow: "발주", title: "발주 정보", description: "봉제와 외주를 한 테이블에서 구분해 관리합니다." },
      production: { eyebrow: "생산", title: "생산 구성", description: "작업에 필요한 원단과 부자재를 정리합니다." },
    },
    sections: {
      orderInfo: {
        title: "발주 정보",
        ...
        orderLineTitle: "발주 항목",
        orderLineDescription: "봉제와 외주를 같은 테이블에서 구분해 관리합니다.",
        sewingLineTypeLabel: "봉제",
        outsourcingLineTypeLabel: "외주",
        orderLineHandoffNote: "봉제는 샘플·메인·재작업을 선택하고, 외주는 등록된 공정과 외주처를 선택합니다. 외주 납기와 세부 완료 처리는 이후 외주공정 화면에서 보완합니다.",
        outsourcingOrder: {
          title: "외주공정 발주",
