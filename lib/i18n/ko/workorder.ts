export const workorderKo = {
  workflowStates: {
    ...
    material_order_pending: "자재 발주 대기",
    inspection: "검수",
    completed: "완료",
    rejected: "반려",
  },
  ...
  ui: {
    ...
    visualSummary: {
      ...
      materialEmpty: "미입력",
      materialDescription: "원단·부자재 구성",
      costLabel: "원가",
      costVisible: "표시 중",
      costHidden: "비공개",
      costVisibleDescription: "관리자 비용 요약 표시",
      costHiddenDescription: "권한에 따라 숨김",
    },
    ...
    memo: {
      ...
      cancel: "취소",
      deleteAria: "메모 삭제",
      empty: "아직 등록된 작업메모가 없습니다. 필요한 확인사항이나 진행 메모를 남길 수 있습니다.",
    ...
    attachmentPanel: {
      ...
      orderRequestPdfMissingTitle: "저장된 발주서 PDF가 없습니다.",
      orderRequestPdfMissingDescription: "발주요청 이후 PDF가 첨부되지 않았거나 다시 저장해야 하는 경우 이 버튼으로 재생성할 수 있습니다.",
      generateOrderRequestPdfButton: "발주서 PDF 다시 생성",
      ...
      designUploadGuideDescription: "이 영역을 클릭하거나 파일을 드래그해 디자인 이미지를 업로드합니다.",
      attachmentUploadGuide: "첨부 파일 추가",
      attachmentUploadGuideDescription: "이 영역을 클릭하거나 파일을 드래그해 PDF, 이미지, 참고 문서를 업로드합니다.",
    ...
    header: {
      ...
      titleEditSave: "이름 저장",
      titleEditCancel: "취소",
      titleEditHint: "Enter로 저장 · Esc로 취소",
      managerLabel: "담당자",
    ...
    detailGroups: {
      cost: { eyebrow: "", title: "비용 요약", description: "" },
      order: { eyebrow: "", title: "공정 정보", description: "" },
      production: { eyebrow: "", title: "제품 구성", description: "" },
    },
    sections: {
      orderInfo: {
        title: "공정 정보",
        ...
        hub: {
          ...
          scopeEditable: "이 상태에서는 제목, 구분, 공장, 수량, 단가, 장당 로스비를 수정할 수 있습니다.",
      ...
      material: {
        title: "필요 원단/부자재",
        empty: "아직 등록된 필요 원단/부자재가 없습니다.",
        fallbackItem: "필요 자재 {index}",
        amountLabel: "금액",
        addButton: "+ 필요 항목 추가",
      ...
      outsourcing: {
        title: "외주공정",
        empty: "아직 등록된 외주공정이 없습니다.",
        fallbackItem: "외주공정 {index}",
        amountLabel: "금액",
        addButton: "+ 외주공정 추가",
        summaryFormat: "{name}{andMore}",
      ...
      productionComposition: {
        title: "제품 구성",
        summaryMaterialCount: "필요 자재 {count}개",
        summaryOutsourcingCount: "외주공정 {count}개",
        summaryTotal: "",
      },
      costSummary: {
        summaryTitle: "",
    ...
    layout: {
      ...
      workOrderListCard: {
        ...
        rework: "재작업",
        delete: "삭제",
        moreActionsAria: "작업지시서 추가 작업 열기",
      },
