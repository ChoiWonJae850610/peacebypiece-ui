export const workorderKo = {
  ...
  lifecycle: {
    ...
    deleteModalNotice: "작업지시서는 휴지통/숨김 상태로 이동합니다. 연결된 디자인, 첨부파일, 메모 첨부도 함께 휴지통으로 이동하는 정책으로 정리합니다.",
    deleteModalPolicyNotice: "휴지통 항목은 30일 이내 복원할 수 있으며, 30일 후 시스템관리자 R2 영구 삭제 후보가 됩니다.",
  ...
  ui: {
    ...
    attachmentPanel: {
      ...
      drawingPlaceholderTitle: "직접 그리기 준비 중",
      drawingPlaceholderDescription: "PC와 태블릿에서 디자인을 직접 스케치하고 작업지시서 디자인 첨부로 저장하는 기능을 준비하고 있습니다.",
      drawingPlaceholderPlan: "다음 단계에서 캔버스 라이브러리를 연결한 뒤, 그린 이미지를 디자인 파일로 저장하고 대표 이미지 후보로 사용할 수 있게 정리합니다.",
      drawingPlaceholderConfirm: "확인",
      drawingPlaceholderClose: "직접 그리기 안내 닫기",
