  ...
  ui: {
    ...
    sections: {
      ...
      material: {
        ...
        handoffNote: "거래처, 단가, 확정 수량, 배송 정보는 원단·부자재 발주 화면에서 정합니다.",
    ...
    layout: {
      ...
      sidebarControls: {
        ...
        create: "작업지시서 생성",
        empty: "검색 결과가 없습니다.",
        loadingDetailTitle: "작업지시서를 불러오고 있습니다.",
        loadingDetailDescription: "선택한 작업지시서 정보를 확인하고 있습니다.",
        loadingSideTitle: "첨부·디자인·메모를 불러오는 중입니다.",
        loadingSideDescription: "첨부, 디자인, 메모를 확인하고 있습니다.",
      },
      mobileTopBar: {
        title: "WAFL",
        subtitle: "모바일 작업 메뉴",
