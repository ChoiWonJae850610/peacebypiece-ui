export const workorderKo = {
  ...
  lifecycle: {
    ...
    deleteModalNotice: "작업지시서는 목록에서 숨겨집니다. 연결된 첨부파일 휴지통 이동은 다음 정책 작업에서 분리해 처리합니다.",
    deleteModalPolicyNotice: "삭제 파일은 휴지통에서 30일 이내 복원할 수 있도록 정리할 예정입니다.",
    deleteModalConfirmLabel: "삭제",
