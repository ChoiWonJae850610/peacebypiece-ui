export const workorderKo = {
  ...
  lifecycle: {
    ...
    saveProcessingToast: "작업지시서 정보 변경 중입니다.",
    saveCompletedToast: "정보가 변경되었습니다.",
    orderInfoLockedToast: "발주정보 전환 규칙상 변경할 수 없습니다.",
    saveFailedToast: "정보를 변경하지 못했습니다.",
  ...
  ui: {
    ...
    emptyWorkspace: {
      ...
      sideTitle: "첨부·디자인을 확인할 작업지시서를 선택해 주세요",
      sideDescription:
    ...
    attachmentPanel: {
      ...
      attachmentUploadGuideDescription: "PDF, 이미지, 문서를 올립니다.",
    ...
    detailGroups: {
      ...
      order: { eyebrow: "", title: "제작 공정", description: "" },
    ...
    layout: {
      ...
      sidebarControls: {
        ...
        loadingSideTitle: "첨부·디자인을 불러오는 중입니다.",
        loadingSideDescription: "첨부와 디자인을 확인하고 있습니다.",
      },
      mobileTopBar: {
        title: "WAFL",
        subtitle: "모바일 작업 메뉴",
      ...
      mobileDrawer: {
        ...
        relatedSections: {
          openLabel: "첨부",
          openAria: "첨부·디자인 추가정보 열기",
          openTitle: "첨부와 디자인을 한 번에 여는 추가정보 패널입니다.",
          attachment: "첨부",
          design: "디자인",
          tabsAria: "작업지시서 연결 정보 섹션",
          description: "모바일에서는 첨부와 디자인을 분리해서 확인합니다.",
          titles: {
            attachment: "첨부 파일",
            design: "디자인 파일",
          },
