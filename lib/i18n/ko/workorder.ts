  ...
  ui: {
    ...
    attachmentPanel: {
      ...
      drawingModal: {
        ...
        toolHelp: "펜 색상과 굵기를 고른 뒤 태블릿 펜 또는 마우스로 그립니다. undo/redo는 최근 작업 기준으로 동작합니다.",
        mobileToolHelp: "모바일은 간단 스케치 모드입니다. 작은 화면에서는 가로 모드가 안정적입니다.",
        pen: "펜",
        eraser: "지우개",
        clear: "전체 지우기",
        undo: "되돌리기",
        ...
        save: "디자인으로 저장",
        saving: "저장 중...",
        colorGroupAria: "펜 색상 선택",
        strokeSizeGroupAria: "펜 굵기 선택",
        colorLabels: {
          black: "검정",
          red: "빨강",
          blue: "파랑",
