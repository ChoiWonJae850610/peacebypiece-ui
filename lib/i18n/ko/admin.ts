export const adminKo = {
  ...
  adminConsole: {
    ...
    links: {
      ...
      legal: {
        label: "약관·정책",
        description:
          "이용약관, 개인정보처리방침, 서비스 운영정책, 데이터 보관·삭제정책을 확인합니다.",
      },
      "standard-units": {
        label: "단위표준",
        description:
  ...
  memberManagement: {
    ...
    detailModal: {
      ...
      simplePermissions: {
        workorderManage: {
          label: "작업지시서 관리",
          description:
            "해제하면 본인 담당 작업지시서 조회만 가능하고, 선택하면 작성중 작업지시서의 생성·수정·삭제·검토요청이 가능합니다.",
        },
        partnerManage: {
          label: "협력업체 관리",
          description:
        ...
        workorderOrderDirect: {
          label: "작업지시서 발주 가능",
          description:
            "선택하면 검토요청을 거치지 않고 직접 발주요청할 수 있으며, 필요하면 검토요청 절차도 사용할 수 있습니다.",
        },
        workorderReview: {
          label: "재고 검수 가능",
          description:
            "선택하면 모든 업무 단계에서 작업지시서 현재 재고를 수정하고 검수 상태를 변경할 수 있습니다.",
        },
        materialOrderRequest: {
          label: "원단·부자재 주문 가능",
          description:
            "선택하면 담당 작업지시서에 필요한 원단·부자재 주문 요청을 작성하거나 수정할 수 있습니다.",
        },
        materialOrderPlace: {
          label: "원단·부자재 발주 가능",
          description:
            "선택하면 원단·부자재 발주서의 발주요청과 발주 상태 변경을 진행할 수 있습니다.",
        },
      },
      actions: {
        save: "저장",
    ...
    inviteBuilder: {
      ...
      actions: {
        ...
        copyDesktopDisabled: "PC 화면에서는 초대 링크 복사를 비활성화합니다.",
        share: "초대 링크 공유",
        shareDisabled: "사용할 수 없는 초대는 공유할 수 없습니다.",
        create: "초대 생성",
        creating: "생성 중",
        cancel: "초대 취소",
        cancelShort: "취소",
      ...
      share: {
        title: "WAFL 초대 링크",
        text: "WAFL 멤버 초대 링크입니다.",
      },
      feedback: {
        created: "초대 링크가 생성되었습니다.",
        copied: "링크가 복사되었습니다.",
        shared: "초대 링크 공유창을 열었습니다.",
        shareFallbackCopied: "공유를 지원하지 않는 기기라 링크를 복사했습니다.",
  ...
  topbar: {
    ...
    summaries: {
      ...
      dashboard: "기간별 작업 · 협력업체 · 저장소",
      settings: "회사 계정 · 기준정보 · 정책 관리",
      members: "멤버 · 권한 · 승인 관리",
  ...
  settings: {
    ...
    accountRequest: {
      ...
      historyEyebrow: "요청 이력",
      historyTitle: "최근 접수된 회사 계정 요청",
      historyDescription: "회사 정보 변경과 계정 비활성화 요청의 최근 접수 상태를 확인합니다.",
      historyBadge: "최근 5건",
      historyEmptyTitle: "접수된 요청이 없습니다.",
      ...
      type: {
        companyInfoChange: "회사 정보 변경",
        accountDeactivation: "계정 비활성화",
      },
    },
    billing: {
