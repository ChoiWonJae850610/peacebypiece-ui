export const adminKo = {
  ...
  filesSummary: { title: "저장소 사용 현황", description: "요금제 용량, 파일 상태, 파일 유형을 현재 기준으로 확인합니다.", periods: { 7: "7일", 15: "15일", 30: "30일" }, uploadAmount: "첨부량", count: "건수", fileType: "파일 유형", countSuffix: "개", totalUsage: "전체 사용량", attachments: "첨부파일", trash: "휴지통", retentionPeriod: "보관 기간", usage: "사용량", refreshLabel: "저장소 데이터 새로고침", documents: "문서", designs: "디자인", memos: "작업메모", others: "기타", storagePlanLabel: "요금제 용량", currentPlan: "현재 요금제", pendingPlan: "확인 중", upgrade: "업그레이드", upgradeTitle: "요금제 업그레이드 화면은 후속 버전에서 연결합니다.", planCapacityPending: "요금제 확인 중", planCapacityLoading: "요금제 용량 확인 중", planCapacityLoadingDescription: "고객 정보의 요금제 용량을 불러오는 중", usedSuffix: "사용", remainingSuffix: "남음", fileOperationsLabel: "파일 운영", fileOperationsTitle: "파일 운영 요약", totalLabel: "전체", activeFiles: "사용중 파일", trashFiles: "휴지통 파일", purgeRequestedFiles: "삭제 요청", zeroTrashSize: "0MB 보관", zeroPurgeRequestSize: "0MB 처리 대기", statuses: { normal: "정상", caution: "주의", danger: "위험" }, units: { count: "개", day: "일" } },
  filesList: { title: "첨부파일 목록", sort: { latest: "최신순", size: "용량순", workorder: "작업지시서명순" }, selectAll: "전체 선택", clearAll: "전체 해제", emptyTrash: "비우기", delete: "삭제", restore: "복원", purge: "선택 삭제", processing: "처리 중", empty: "표시할 첨부파일이 없습니다.", trashEmpty: "휴지통에 보관 중인 항목이 없습니다.", restoreSkipsBlockedItems: "복원할 수 없는 선택 항목은 제외하고 처리합니다.", purgeSkipsBlockedItems: "삭제 요청할 수 없는 선택 항목은 제외하고 처리합니다.", selectWorkOrder: "작업지시서 선택", deselectWorkOrder: "작업지시서 선택 해제", selectItem: "선택", deselectItem: "선택 해제", countSuffix: "개", columns: { select: "선택", target: "대상", workorder: "작업지시서", createdAt: "생성일자", deletedAt: "삭제일시", fileName: "파일명", type: "유형", size: "크기" }, selectedScope: { workorder: "작업지시서", workorderValue: "대표 row 1건", bundleAttachments: "묶음 처리 첨부", restoreBlocked: "복원 불가 파일", totalSize: "연결 파일 용량" }, emptyTrashConfirmTitle: "휴지통 비우기", emptyTrashConfirmDescription: "휴지통의 모든 항목을 삭제 요청하시겠습니까?", workorderPurgePreview: "선택 삭제 범위 확인", workorderRestorePreview: "복원 범위 확인", workorderActionGuardTitle: "작업지시서 단위로 처리 범위를 확인합니다.", workorderRestoreConnectedNotice: "작업지시서와 첨부된 파일/메모가 함께 복원됩니다.", workorderActionSkeletonNotice: "선택 삭제는 고객관리자 삭제 요청으로 처리하고 휴지통 기본 목록에서 제외합니다. R2 파일 삭제는 시스템관리자 Worker 기반 purge 흐름에서만 처리됩니다.", workorderRestoreGuardDescription: "복원 연결 시 작업지시서와 묶음 삭제 상태의 문서/디자인/메모를 같은 트랜잭션에서 복원해야 합니다.", workorderPurgeGuardDescription: "선택 삭제 시 Neon row는 hard delete하지 않고 delete_status/purge_status를 삭제 요청 상태로 표시합니다. 작업지시서에 딸린 R2 파일은 직접 삭제하지 않습니다.", fileTypes: { document: "문서", design: "디자인", other: "기타" } },
  trashPage: { title: "휴지통" },
