export const adminKo = {
  ...
  dashboardPage: {
    ...
    categoryDetailTitleFirst: "{label} 품목 TOP5",
    categoryDetailTitleSecond: "{label} 세부형태 TOP5",
    ...
    periodTopEyebrow: "기간별 TOP5",
    periodTopCompletedTitle: "발주수량 상위 TOP5",
    periodTopReorderTitle: "리오더 차수 TOP5",
    periodTopDefectTitle: "불량 작업지시서 TOP5",
    ...
    reorderTopTitle: "기간별 리오더 차수 TOP5",
