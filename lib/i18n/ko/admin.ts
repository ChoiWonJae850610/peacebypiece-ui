export const adminKo = {
  ...
  filesList: { title: "첨부파일 목록", sort: { latest: "최신순", size: "용량순", workorder: "작업지시서명순" }, selectAll: "전체 선택", clearAll: "전체 해제", emptyTrash: "비우기", delete: "삭제", restore: "복원", purge: "선택 삭제", empty: "표시할 첨부파일이 없습니다.", trashEmpty: "휴지통에 보관 중인 파일이 없습니다.", columns: { select: "선택", workorder: "작업지시서명", createdAt: "생성일자", deletedAt: "삭제일시", fileName: "파일명", type: "유형", size: "용량" }, emptyTrashConfirmTitle: "휴지통 비우기", emptyTrashConfirmDescription: "휴지통의 모든 항목을 삭제 요청하시겠습니까?", fileTypes: { document: "문서", design: "디자인", other: "기타" } },
  trashPage: { title: "휴지통" },
