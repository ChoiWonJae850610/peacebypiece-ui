export const workorderEn = {
  ...
  ui: {
    ...
    attachmentPanel: {
      ...
      orderRequestPdfMissingTitle: "No saved order PDF.",
      orderRequestPdfMissingDescription: "If the PDF was not attached after the order request or needs to be saved again, regenerate it here.",
      generateOrderRequestPdfButton: "Regenerate order PDF",
