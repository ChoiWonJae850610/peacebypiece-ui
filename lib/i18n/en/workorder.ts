  ...
  ui: {
    ...
    sections: {
      ...
      material: {
        ...
        amountLabel: "Confirmed amount",
        addButton: "+ Add required item",
        summaryFormat: "{name}{andMore} · Rough input",
        ...
        fields: {
          type: "Type",
          name: "Required item",
          vendor: "Confirmed supplier",
          quantity: "Rough qty",
          unit: "Rough unit",
          unitCost: "Confirmed unit cost",
          amount: "Confirmed amount",
        },
      },
      outsourcing: {
        title: "Expected outsourcing",
        empty: "No expected outsourcing processes registered.",
        fallbackItem: "Expected process {index}",
        amountLabel: "Confirmed amount",
        addButton: "+ Add expected process",
        summaryFormat: "{name}{andMore} · Rough input",
