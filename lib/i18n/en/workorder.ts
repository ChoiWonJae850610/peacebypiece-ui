export const workorderEn = {
  ...
  ui: {
    ...
    detailGroups: {
      cost: { eyebrow: "", title: "Cost", description: "" },
    ...
    sections: {
      orderInfo: {
        ...
        hub: {
          ...
          scopeEditable: "Title, type, factory, quantity, unit cost, and loss per unit remain editable in this state.",
      ...
      costSummary: {
        ...
        empty: "No process amount to display.",
      },
    },
    modals: {
      basicInfo: {
