export const workorderEn = {
  ...
  lifecycle: {
    ...
    deleteModalNotice: "The work order moves to a trash/hidden state. Linked design files, attachments, and memo attachments are handled as part of the same trash policy.",
    deleteModalPolicyNotice: "Trash items remain restorable for 30 days, then become system-admin R2 purge candidates.",
