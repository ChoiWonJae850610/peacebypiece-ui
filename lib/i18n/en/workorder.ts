  ...
  ui: {
    ...
    attachmentPanel: {
      ...
      drawingModal: {
        ...
        toolHelp: "Choose a pen color and stroke size, then draw with a tablet pen or mouse. Undo/redo works on recent drawing steps.",
        mobileToolHelp: "Mobile uses simple sketch mode. Landscape mode is more stable on smaller screens.",
        pen: "Pen",
        eraser: "Eraser",
        clear: "Clear all",
        undo: "Undo",
        ...
        save: "Save as design",
        saving: "Saving...",
        colorGroupAria: "Pen color selection",
        strokeSizeGroupAria: "Stroke size selection",
        colorLabels: {
          black: "Black",
          red: "Red",
          blue: "Blue",
