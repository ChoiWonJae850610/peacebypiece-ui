export const adminEn = {
  ...
  operationsDashboard: {
    title: "Operations",
    sourceDb: "Operational status from DB",
    ...
    countSuffix: " items",
    statusDistribution: { working: "Working", reviewWaiting: "Review waiting", inboundWaiting: "Inbound waiting", completed: "Completed" },
    insights: {
      createdToday: "Created today",
      createdInPeriod: "Created in period",
      createdDescription: "Work orders newly created in the selected period",
      reviewDelayed: "Review delayed",
      reviewDelayedDescription: "Work orders more than 24 hours after review request",
