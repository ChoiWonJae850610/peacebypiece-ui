export const adminEn = {
  ...
  filesSummary: { title: "Storage usage", description: "Review plan capacity, file state, and file types on the current basis.", periods: { 7: "7 days", 15: "15 days", 30: "30 days" }, uploadAmount: "Uploads", count: "Count", fileType: "File type", countSuffix: "items", totalUsage: "Total usage", attachments: "Attachments", trash: "Trash", retentionPeriod: "Storage period", usage: "Usage", refreshLabel: "Refresh storage data", documents: "Documents", designs: "Designs", memos: "Work memos", others: "Other", storagePlanLabel: "Storage plan", currentPlan: "Current plan", pendingPlan: "Checking", upgrade: "Upgrade", upgradeTitle: "Plan upgrade screen will be connected in a later version.", planCapacityPending: "Checking plan", planCapacityLoading: "Checking plan capacity", planCapacityLoadingDescription: "Loading the customer plan capacity", usedSuffix: "used", remainingSuffix: "remaining", fileOperationsLabel: "File operations", fileOperationsTitle: "File operations summary", totalLabel: "Total", activeFiles: "Active files", trashFiles: "Trash files", purgeRequestedFiles: "Deletion requests", zeroTrashSize: "0MB stored", zeroPurgeRequestSize: "0MB pending", statuses: { normal: "Normal", caution: "Caution", danger: "Risk" }, units: { count: "items", day: "days" } },
  filesList: { title: "Attachments", sort: { latest: "Newest", size: "By size", workorder: "By work order" }, selectAll: "Select all", clearAll: "Clear all", emptyTrash: "Empty trash", delete: "Delete", restore: "Restore", purge: "Request deletion", processing: "Processing", empty: "No attachments to display.", trashEmpty: "No items are currently in trash.", restoreSkipsBlockedItems: "Items that cannot be restored will be excluded.", purgeSkipsBlockedItems: "Items that cannot be requested for deletion will be excluded.", selectWorkOrder: "Select work order", deselectWorkOrder: "Deselect work order", selectItem: "Select", deselectItem: "Deselect", countSuffix: "items", columns: { select: "Select", target: "Target", workorder: "Work order", createdAt: "Created", deletedAt: "Deleted", fileName: "File name", type: "Type", size: "Size" }, selectedScope: { workorder: "Work order", workorderValue: "1 representative row", bundleAttachments: "Bundled attachments", restoreBlocked: "Restore-blocked files", totalSize: "Linked file size" }, emptyTrashConfirmTitle: "Empty trash", emptyTrashConfirmDescription: "Request deletion for all items in trash?", workorderPurgePreview: "Confirm deletion request scope", workorderRestorePreview: "Confirm restore scope", workorderActionGuardTitle: "Review the work-order-level processing scope.", workorderRestoreConnectedNotice: "The work order and attached files/memos will be restored together.", workorderActionSkeletonNotice: "Request deletion as a customer admin action and hide it from the default trash list. R2 file deletion is only handled through the system-admin Worker purge flow.", workorderRestoreGuardDescription: "Restoring must restore the work order and bundled document/design/memo records in one transaction.", workorderPurgeGuardDescription: "Request deletion marks Neon rows with delete_status/purge_status and does not hard-delete them. R2 files attached to the work order are not directly deleted.", fileTypes: { document: "Document", design: "Design", other: "Other" } },
