export const adminEn = {
  ...
  dashboardPage: {
    ...
    periodTopReorderEmpty: "No reorder work order data.",
    periodTopDefectEmpty: "No defective work order data.",
    periodTopCompletedBasis: "Based on total order quantity from completed work orders",
    periodTopReorderBasis: "Based on the number of second-round or later reorder work orders",
    periodTopDefectBasis: "Based on work orders with one or more defects recorded",
