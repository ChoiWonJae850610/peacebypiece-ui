...
export const ADMIN_WORKSPACE_CARD_PERMISSIONS = [
  ...
  ADMIN_WORKSPACE_PERMISSIONS.partnerRead,
  ADMIN_WORKSPACE_PERMISSIONS.partnerCreate,
  ADMIN_WORKSPACE_PERMISSIONS.partnerUpdate,
  ADMIN_WORKSPACE_PERMISSIONS.partnerDelete,
  ...
  ADMIN_WORKSPACE_PERMISSIONS.standardsRead,
  ADMIN_WORKSPACE_PERMISSIONS.standardsCreate,
  ADMIN_WORKSPACE_PERMISSIONS.standardsUpdate,
  ADMIN_WORKSPACE_PERMISSIONS.standardsDelete,
  ADMIN_WORKSPACE_PERMISSIONS.standardsManage,
