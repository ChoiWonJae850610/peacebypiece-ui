...
export const MEMBER_ROLE_TEMPLATE_POLICIES: readonly MemberRoleTemplatePolicy[] = [
  ...
  },
  {
    ...
    sortOrder: 30,
    permissionCodes: ["workorder.read", "workorder.status.inspect", "workorder.status.complete", "partner.read", "standards.read", "storage.read", "personal_settings.manage"],
  },
  {
    ...
    sortOrder: 40,
    permissionCodes: ["workorder.read", "workorder.update", "workorder.status.order", "partner.read", "partner.create", "partner.update", "standards.read", "standards.create", "standards.update", "storage.read", "personal_settings.manage"],
  },
  {
    code: "viewer",
