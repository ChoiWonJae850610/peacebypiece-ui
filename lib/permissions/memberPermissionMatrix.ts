...
export const MEMBER_PERMISSION_CATALOG: readonly MemberPermissionCatalogItem[] = [
  ...
  { code: "workorder.status.review", group: "workorder", labelKey: "permissions.workorder.statusReview.label", descriptionKey: "permissions.workorder.statusReview.description", systemOnly: false, sortOrder: 60 },
  { code: "workorder.status.order", group: "workorder", labelKey: "permissions.workorder.statusOrder.label", descriptionKey: "permissions.workorder.statusOrder.description", systemOnly: false, sortOrder: 70 },
  { code: "workorder.status.inspect", group: "workorder", labelKey: "permissions.workorder.statusInspect.label", descriptionKey: "permissions.workorder.statusInspect.description", systemOnly: false, sortOrder: 80 },
  { code: "workorder.status.complete", group: "workorder", labelKey: "permissions.workorder.statusComplete.label", descriptionKey: "permissions.workorder.statusComplete.description", systemOnly: false, sortOrder: 90 },
  ...
  { code: "partner.manage", group: "partner", labelKey: "permissions.partner.manage.label", descriptionKey: "permissions.partner.manage.description", systemOnly: false, sortOrder: 120 },
  ...
  { code: "standards.manage", group: "settings", labelKey: "permissions.standards.manage.label", descriptionKey: "permissions.standards.manage.description", systemOnly: false, sortOrder: 190 },
...
export const MEMBER_ROLE_TEMPLATE_POLICIES: readonly MemberRoleTemplatePolicy[] = [
  ...
  },
  {
    ...
    sortOrder: 20,
    permissionCodes: ["workorder.read", "workorder.create", "workorder.update", "workorder.status.review", "partner.read", "storage.read", "personal_settings.manage"],
  },
  {
    code: "inspector",
    ...
    sortOrder: 30,
    permissionCodes: ["workorder.read", "workorder.status.inspect", "workorder.status.complete", "partner.read", "storage.read", "personal_settings.manage"],
  },
  {
    ...
    sortOrder: 40,
    permissionCodes: ["workorder.read", "workorder.status.order", "partner.read", "storage.read", "personal_settings.manage"],
  },
  {
    code: "viewer",
    ...
    sortOrder: 50,
    permissionCodes: ["workorder.read", "partner.read", "personal_settings.manage"],
  },
] as const;
