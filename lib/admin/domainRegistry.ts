...
export const ADMIN_DOMAIN_STRUCTURE: AdminDomainStructureItem[] = [
  ...
  { key: "stats", label: "통계정보", basePath: "lib/admin/stats", layers: ["types", "selector", "actionFlow", "presentation", "repository"] },
  { key: "history", label: "히스토리", basePath: "lib/admin/history", layers: ["types", "selector", "actionFlow", "presentation", "repository"] },
