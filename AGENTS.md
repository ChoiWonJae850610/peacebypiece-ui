...
- For WAFL v2 App-first / `2.0.x` work, Codex must read this order before any file modification:
  ...
  28. `docs/project/v2/00-start-here.md` through `docs/project/v2/14-operational-policy-absorption.md`
  29. `docs/project/25-korean-unicode-encoding-standard.md`
  30. `docs/project/32-product-completion-and-ui-evidence-standard.md`
  31. `docs/project/26-final-policy-decisions-and-master-todo.md`
  32. `docs/project/31-pre-codex-integrated-master-plan.md`
