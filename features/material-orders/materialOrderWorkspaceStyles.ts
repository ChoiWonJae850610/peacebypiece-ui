...
export const MATERIAL_ORDER_PANEL_LIST_CLASS =
  "min-h-0 flex-1 space-y-2 overflow-y-auto overscroll-contain py-3 pr-1 [scrollbar-gutter:stable]";
...
export const MATERIAL_ORDER_SECTION_CARD_CLASS =
  "wafl-shape-control border border-[var(--pbp-border)] bg-[var(--pbp-surface)] p-4 shadow-none xl:p-4";
...
export const MATERIAL_ORDER_EMPTY_STATE_CLASS =
  "wafl-shape-control border border-dashed border-[var(--pbp-empty-state-border)] bg-[var(--pbp-empty-state-surface)] p-3 text-sm shadow-none";
