...
export const MATERIAL_ORDER_PANEL_HEADER_CLASS =
  "shrink-0 border-b border-[var(--pbp-border)] pb-3";
...
export const MATERIAL_ORDER_SECTION_CARD_CLASS =
  "rounded-[24px] border border-[var(--pbp-border)] bg-[var(--pbp-surface)] p-4 shadow-sm xl:p-4";

export const MATERIAL_ORDER_TABLE_SHELL_CLASS =
  "max-w-full min-h-0 flex-1 overflow-auto rounded-2xl border border-[var(--pbp-border)] bg-[var(--pbp-surface)]";

export const MATERIAL_ORDER_LIST_CARD_BASE_CLASS =
  "group pbp-interactive-card w-full min-w-0 rounded-2xl border p-3 text-left transition";
...
export const MATERIAL_ORDER_NESTED_ROW_CLASS =
  "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-2xl border border-[var(--pbp-border)] bg-[var(--pbp-surface)] px-3 py-2.5";

export const MATERIAL_ORDER_EMPTY_STATE_CLASS =
  "rounded-2xl border border-dashed border-[var(--pbp-border)] bg-[var(--pbp-surface-soft)] p-3 text-sm";
