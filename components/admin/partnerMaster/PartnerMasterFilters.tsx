  ...
  return (
    <AdminFilterBar className="mt-3 block shrink-0 border-[var(--pbp-border)] bg-[var(--pbp-surface-muted)] px-3 py-3 transition-colors md:px-4">
      <div className="grid gap-4 lg:grid-cols-[220px_minmax(520px,1fr)_minmax(240px,0.7fr)_150px] lg:items-end lg:gap-4 xl:grid-cols-[230px_minmax(560px,1fr)_minmax(250px,0.7fr)_160px] xl:gap-5">
        ...
        <div className="min-w-0 space-y-2 lg:w-full lg:min-w-0 lg:justify-self-stretch">
          <p className="text-[13px] font-semibold text-[var(--pbp-text-muted)]">{filterText.typeLabel}</p>
          <div className="flex flex-wrap gap-2 lg:flex-nowrap lg:overflow-visible lg:justify-start">
            {filterOptions.map((item) => {
              ...
              return (
                <AdminButton
                  ...
                  size="sm"
                  className="whitespace-nowrap lg:px-3 xl:px-4"
                >
                  {item.label}
                </AdminButton>
              );
        ...
        <div className="flex min-w-0 items-end lg:col-span-1 lg:justify-self-end">
