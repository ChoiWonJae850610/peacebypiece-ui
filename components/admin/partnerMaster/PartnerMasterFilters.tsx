...
export default function PartnerMasterFilters({
  ...
  return (
    <AdminFilterBar className="mt-3 shrink-0 border-[var(--pbp-border)] bg-[var(--pbp-surface-muted)] px-3 py-3 transition-colors md:px-4">
      <div className="grid min-w-0 gap-3 min-[1120px]:grid-cols-[minmax(0,1fr)_auto] min-[1120px]:items-end">
        <label className="min-w-0 space-y-2 min-[1120px]:max-w-[560px]">
        ...
        <div className="grid min-w-0 grid-cols-2 gap-3 min-[720px]:ml-auto min-[720px]:w-full min-[720px]:max-w-[400px] min-[1120px]:w-[400px]">
