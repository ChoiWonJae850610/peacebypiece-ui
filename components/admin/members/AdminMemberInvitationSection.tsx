...
const MEMBER_INVITE_PANEL_HEIGHT_CLASS = "min-h-fit touch-pan-y 2xl:h-[452px] 2xl:min-h-[452px]";
const MEMBER_INVITE_PANEL_CONTENT_CLASS = "flex min-h-fit flex-col overflow-visible overscroll-auto pt-4 2xl:min-h-0 2xl:flex-1";
const MEMBER_INVITATION_TABLE_CONTENT_CLASS =
  "flex min-h-fit flex-col overflow-visible overscroll-auto pt-4 2xl:min-h-0 2xl:flex-1";
const MEMBER_INVITATION_TABLE_VIEWPORT_CLASS = "min-h-fit touch-pan-y 2xl:min-h-0 2xl:flex-1";
...
export default function AdminMemberInvitationSection({
  ...
  return (
    <section
      ...
      className="grid items-stretch gap-5 2xl:grid-cols-[1.46fr_0.74fr]"
    >
      ...
      >
        <AdminTable
          ...
          gridTemplateColumns="58px minmax(118px,1fr) 76px 68px"
          headerClassName="hidden shrink-0 gap-1.5 bg-[var(--pbp-surface-muted)] px-2.5 py-2 text-[10px] font-semibold text-[var(--pbp-text-muted)] 2xl:grid"
          rowBaseClassName="grid w-full min-w-0 gap-1.5 px-2.5 py-2.5 text-left text-[11px] md:items-center"
