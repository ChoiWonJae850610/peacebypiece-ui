...
export const WAFL_PAGE_HERO_CLASS =
  "w-full min-w-0 overflow-hidden rounded-[32px] border border-[var(--pbp-border-strong)] bg-[linear-gradient(135deg,var(--pbp-surface-soft)_0%,var(--pbp-surface)_62%,var(--pbp-surface-muted)_130%)] p-5 shadow-[var(--pbp-shadow-elevated)] sm:p-6";
