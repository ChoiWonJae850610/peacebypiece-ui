...
export const ADMIN_ACTIVE_TAB_CLASS =
  "border-transparent pbp-action-primary shadow-sm";
export const ADMIN_INACTIVE_TAB_CLASS =
...
export const ADMIN_STORAGE_PILL_CLASS =
  "rounded-full border border-[var(--pbp-border)] bg-[var(--pbp-surface-muted)] px-3 py-1.5 text-xs font-semibold text-[var(--pbp-text-muted)]";
...
export const ADMIN_STORAGE_VALUE_CLASS =
  "font-bold text-[var(--pbp-text-primary)]";
...
export const ADMIN_STORAGE_SELECTED_ROW_CLASS =
  "bg-[var(--pbp-selected-surface)] ring-1 ring-inset ring-[var(--pbp-selected-border)]";
export const ADMIN_STORAGE_ROW_CLASS =
  "bg-[var(--pbp-surface)] hover:bg-[var(--pbp-surface-muted)]";
...
export const ADMIN_STORAGE_WARNING_BOX_CLASS =
  "rounded-2xl border border-[var(--pbp-status-warning)] bg-[var(--pbp-status-warning-soft)] px-3 py-3 text-xs leading-5 text-[var(--pbp-status-warning)]";
...
export const ADMIN_STORAGE_TABLE_HEADER_CLASS =
  "hidden gap-3 bg-[var(--pbp-surface-muted)] px-4 py-2 text-[10px] font-semibold text-[var(--pbp-text-muted)] md:grid";
export const ADMIN_STORAGE_TABLE_HEADER_COMPACT_CLASS =
  "hidden shrink-0 gap-3 bg-[var(--pbp-surface-muted)] px-3.5 py-1.5 text-[10px] font-semibold text-[var(--pbp-text-muted)] md:grid";
...
export const ADMIN_STATS_IDLE_ITEM_CLASS =
  "border-[var(--pbp-border)] bg-[var(--pbp-surface)] hover:border-[var(--pbp-border-strong)] hover:bg-[var(--pbp-surface-muted)]";
export const ADMIN_STATS_TITLE_CLASS = "text-[var(--pbp-text-primary)]";
export const ADMIN_STATS_BODY_CLASS = "text-[var(--pbp-text-muted)]";
export const ADMIN_STATS_SUBTLE_TEXT_CLASS = "text-[var(--pbp-text-subtle)]";
export const ADMIN_STATS_TRACK_CLASS = "bg-[var(--pbp-surface-muted)]";
export const ADMIN_STATS_TRACK_INSET_CLASS = "bg-[var(--pbp-surface)]";
export const ADMIN_STATS_ACCENT_TEXT_CLASS =
  "text-[var(--admin-theme-surface)]";
export const ADMIN_STATS_ACCENT_BAR_CLASS = "bg-[var(--admin-theme-surface)]";
export const ADMIN_STATS_WARNING_PANEL_CLASS =
  "border-dashed border-[var(--pbp-status-warning)] bg-[var(--pbp-status-warning-soft)]";
export const ADMIN_STATS_WARNING_TEXT_CLASS =
