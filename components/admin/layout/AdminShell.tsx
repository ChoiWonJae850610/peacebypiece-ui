  ...
  return (
    <I18nProvider initialLocale={DEFAULT_LOCALE}>
      <AdminThemeScope>
        ...
        <div className="mx-auto flex h-full w-full max-w-[1480px] flex-col gap-5 overflow-hidden lg:flex-row lg:items-stretch">
          <AdminSidebar companyName={companyName} appVersion={appVersion} navigationItems={navigationItems} />
          <div className="flex min-w-0 flex-1 flex-col gap-4 overflow-hidden md:gap-5">
