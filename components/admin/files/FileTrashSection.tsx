...
export default function FileTrashSection({
  ...
  return (
    <section className={`${ADMIN_STORAGE_PANEL_TIGHT_CLASS} flex min-h-[360px] touch-pan-y flex-col p-2.5 md:p-3 xl:h-full xl:min-h-0`}>
      <AdminActionBar
      ...
      <AdminTable
        className="mt-2 min-h-[320px] touch-pan-y xl:min-h-0 xl:flex-1"
