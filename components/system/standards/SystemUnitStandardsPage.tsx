        ...
        <section className="grid gap-4 lg:grid-cols-[1.4fr_0.6fr]">
          <article className="rounded-3xl border border-stone-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 overflow-hidden rounded-2xl border border-stone-200">
              <div className="grid grid-cols-[0.65fr_0.65fr_0.7fr_1.1fr_0.7fr_0.45fr_0.75fr] gap-3 border-b border-stone-100 bg-stone-50 px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.12em] text-stone-500">
                <span>한글명</span>
                <span>영문 코드</span>
                <span>분류</span>
                <span>설명</span>
              ...
              <div className="max-h-[460px] divide-y divide-stone-100 overflow-y-auto bg-white">
                {records.map((row) => {
                  ...
                  return (
                    <div
                      key={row.id}
                      className="grid grid-cols-[0.65fr_0.65fr_0.7fr_1.1fr_0.7fr_0.45fr_0.75fr] gap-3 px-4 py-3 text-sm text-stone-700"
                    >
                      {isEditing ? (
                        <>
                          <input
                        ...
                        <>
                          ...
                          <span className="text-xs text-stone-500">{SYSTEM_UNIT_STANDARD_CATEGORY_LABELS[row.category] || row.category}</span>
