            ...
            <article key={item.id} className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-xl bg-white p-3">
                  ...
                  <div className="mt-1"><EditableValue section="material" rowId={item.id} field="unit" value={item.unit} options={MATERIAL_UNIT_OPTIONS} editingCell={editingCell} editingValue={editingValue} centered onStartEdit={onStartEdit} onCommit={onCommitEdit} onCancel={onCancelEdit} disabled={locked} /></div>
                </div>
                <div className="rounded-xl bg-white p-3">
