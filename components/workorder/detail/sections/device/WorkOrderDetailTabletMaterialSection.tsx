...
import { AddButton, DeleteButton, SectionHeader, type EditableCell, type EditableSectionKey } from "@/components/workorder/detail/shared/detailEditorShared";
            ...
            <article key={item.id} className="rounded-2xl border border-stone-200 bg-white p-3.5 shadow-sm">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 text-xs text-stone-500">{item.quantity.toLocaleString()} {translateWorkOrderDisplayText(item.unit, locale)}</div>
                </div>
                {!locked ? (
