...
export default function WorkspaceShell({
  ...
  const contentFrameClassName = isFixedFromDesktop
    ...
    : "w-full touch-pan-y overflow-visible overscroll-auto 2xl:min-h-0 2xl:flex-1 2xl:overflow-y-auto 2xl:overscroll-contain";
  ...
  return (
    <AdminThemeScope>
      <main className="min-h-screen touch-pan-y overflow-visible overscroll-auto bg-[var(--pbp-bg-app)] p-3 text-[var(--pbp-text-primary)] sm:p-4 md:p-6 lg:p-8 lg:h-dvh lg:overflow-hidden">
        <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-3 overflow-visible sm:gap-4 md:gap-5 lg:h-full lg:min-h-0 lg:overflow-hidden">
          {hideTopbar ? null : (
            <WorkspaceTopbar
