  ...
  return (
    <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-labelledby="inventory-editor-title">
      ...
      <div
        ref={dialogRef}
        tabIndex={-1}
        className="absolute inset-x-0 bottom-0 flex max-h-[90vh] flex-col overflow-hidden rounded-t-3xl border border-stone-200 bg-white shadow-2xl outline-none md:left-1/2 md:top-1/2 md:bottom-auto md:w-full md:max-w-lg md:max-h-[90vh] md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-3xl"
      >
        <div className="sticky top-0 z-10 shrink-0 border-b border-stone-200 bg-white px-4 py-4 md:px-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-1 text-sm text-stone-500 break-keep">모바일은 드로어, PC는 모달처럼 동작합니다.</div>
            </div>
            <button
              type="button"
              onClick={onClose}
