...
const variantClassMap: Record<WaflButtonVariant, string> = {
  primary: "pbp-action-primary border-transparent shadow-sm hover:bg-[var(--pbp-action-primary-surface-hover)]",
  secondary: "pbp-action-secondary border-[var(--pbp-border)] shadow-sm hover:border-[var(--pbp-border-strong)] hover:bg-[var(--pbp-action-secondary-surface-hover)]",
  ghost: "pbp-action-ghost border-transparent shadow-none hover:bg-[var(--pbp-surface-muted)]",
  danger: "pbp-action-danger border-transparent shadow-sm hover:bg-[var(--pbp-action-danger-surface-hover)]",
