...
export function WaflIconButton(props: WaflActionButtonProps) {
  return <WaflActionButton {...props} />;
}

type WaflMoreActionButtonProps = Omit<WaflActionButtonProps, "children">;

function WaflMoreHorizontalIcon() {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
export function WaflMoreActionButton({ showSrLabel = false, ...props }: WaflMoreActionButtonProps) {
  return (
