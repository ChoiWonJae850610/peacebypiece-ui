...
- 사용자 QA 체크리스트: `docs/qa/0.24.29-integrated-productization-checkpoint.md`
...
- Vercel 배포본은 고객 운영 환경일 수 있으므로 DB/R2/Seed/Reset/Cleanup/Migration/production mutation은 별도 승인 없이 실행하지 않습니다.
- `/id-control`, `/roadmap`, `/ui`, `/functions`는 active system-admin 전용 read/view 화면입니다.
