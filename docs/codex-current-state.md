...
- Approval/provisioning remains a disabled placeholder. Company/user/member/subscription creation, Trial activation, notification email, and live certificate viewer verification remain unimplemented/not completed.
