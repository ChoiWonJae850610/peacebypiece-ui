...
Alpha.32 supersedes the expandable-note interaction with compact single-line editing and realistic print evidence. Alpha.33 clarifies the sample entry and material-card flow; generated-document/PDF/QR/R2 lifecycle moves to alpha.34 under a separate explicit work order and mutation approval.
