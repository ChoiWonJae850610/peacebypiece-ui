    ...
    "automation-infrastructure" = @(
        ...
        @{
            ...
            Arguments = @(
                ...
                "lib/generated-documents/work-order-pdf/internalFileRoute.ts",
                "app/api/v2/work-orders/documents/[documentRef]/file/route.ts",
                ...
                "scripts/run-wafl-v2-alpha40-preview-output-readonly.mjs",
                  ...
                  "lib/mobile-dev-session/tailscaleAutoConnect.ts",
                  "lib/mobile-dev-session/tailscaleIdentity.ts",
                  "lib/mobile-dev-session/tailscaleIdentityCore.mjs",
                  "scripts/resolve-wafl-alpha47-developer-mapping.mjs",
                  ...
                  "apps/mobile/components/InlineDatePicker.tsx",
                  "apps/mobile/app/_layout.tsx",
                  "apps/mobile/application/useWaflRuntimeOrientationPolicy.ts",
                  "apps/mobile/domain/mobileOrientationPolicy.ts",
                  ...
                  "apps/mobile/features/work-orders/drawing/WorkOrderSketchEditor.tsx",
                  ...
                  "apps/mobile/application/sessionController.ts",
                  "apps/mobile/application/useWorkOrderNavigation.ts",
                  "apps/mobile/application/mutationController.ts",
                  "apps/mobile/application/queryState.ts",
                  "apps/mobile/application/sessionState.ts",
                  "apps/mobile/application/draftExitPolicy.ts",
                  "apps/mobile/domain/mobileContract.ts",
                  "apps/mobile/domain/mobileHttpResponse.ts",
                  "apps/mobile/domain/workOrderPolicy.ts",
                  "apps/mobile/domain/workOrderValidation.ts",
                  "apps/mobile/lib/apiClient.ts",
                  "apps/mobile/lib/apiTypes.ts",
                  "apps/mobile/lib/mobileDisplay.ts",
                  "apps/mobile/lib/workOrderDisplay.ts",
                  "apps/mobile/hooks/useDatePickerState.ts",
                  "apps/mobile/features/inputs/reel-picker/reelPickerModel.ts",
                  "apps/mobile/features/inputs/reel-picker/reelPickerState.ts",
                  "apps/mobile/features/inputs/reel-picker/reelPickerHaptics.ts",
                  "apps/mobile/features/inputs/reel-picker/ReelInlineEditValue.tsx",
                   "apps/mobile/features/inputs/reel-picker/WaflReelPickerSheet.tsx",
                   "apps/mobile/features/inputs/reel-picker/waflReelSheetSizingPolicy.ts",
                   "apps/mobile/features/inputs/WaflInputSheet.tsx",
                   "apps/mobile/features/inputs/WaflSheetValueField.tsx",
                   ...
                   "apps/mobile/domain/workOrderSizeSpecRecommendationPolicy.mjs",
                   "apps/mobile/domain/workOrderSizeSpecRecommendationPolicy.d.mts",
                   "lib/domain/work-orders/catalog/workOrderSizeSpecRecommendationPolicy.mjs",
                   "lib/domain/work-orders/catalog/workOrderSizeSpecRecommendationPolicy.d.mts",
                   "lib/domain/work-orders/catalog/systemSpecItemCatalog.mjs",
                   "lib/domain/work-orders/catalog/systemSpecItemCatalog.d.mts",
                  "apps/mobile/features/materials/materialReelAdapter.ts",
                  "apps/mobile/features/work-orders/list/immediateSearchPolicy.ts",
                  "apps/mobile/features/work-orders/list/workOrderSearchPolicy.ts",
                  "apps/mobile/features/work-orders/list/workOrderListStatusPolicy.ts",
                  ...
                  "tests/workorder-v2-alpha46-mobile-basic-info-update-contract.mjs",
                  "tests/workorder-v2-alpha46-command-runtime-boundary-contract.mjs",
                  "tests/workorder-v2-alpha46-mobile-unsaved-conflict-contract.mjs",
                  "tests/workorder-v2-alpha46-date-only-regression-contract.mjs",
                  "tests/workorder-v2-alpha47-tailscale-developer-auto-connect-contract.mjs",
                  ...
                  "tests/workorder-v2-alpha52-mobile-work-order-list-contract.mjs",
                  "tests/workorder-v2-alpha52-mobile-overview-inline-editing-contract.mjs",
                  "tests/workorder-v2-alpha52-mobile-material-inline-editing-contract.mjs",
                  "tests/workorder-v2-alpha52-mobile-inline-focus-contract.mjs",
                  "tests/workorder-v2-alpha52-mobile-inline-visibility-date-picker-contract.mjs",
                  "tests/workorder-v2-alpha52-mobile-numeric-draft-contract.mjs",
                  "tests/workorder-v2-alpha52-mobile-qa-correction-contract.mjs",
                  "tests/workorder-v2-alpha53-mobile-behavior-characterization-contract.mjs",
                  "tests/workorder-v2-alpha53-mobile-application-controller-contract.mjs",
                  "tests/workorder-v2-alpha53-mobile-policy-contract.mjs",
                  "tests/workorder-v2-alpha53-mobile-architecture-foundation-contract.mjs",
                  "tests/workorder-v2-alpha54-reel-picker-model-contract.mjs",
                  "tests/workorder-v2-alpha54-material-reel-draft-contract.mjs",
                  "tests/workorder-v2-alpha54-immediate-search-contract.mjs",
                  "tests/workorder-v2-alpha54-user-qa-remediation-contract.mjs",
                  ...
                  "tests/workorder-v2-alpha69-item-size-spec-recommendation-contract.mjs",
                  "tests/workorder-v2-alpha69-target-major-standard-spec-staged-replacement-contract.mjs",
                  "tests/workorder-v2-alpha69-standard-spec-seed-decision-blocker-contract.mjs",
                  ...
                  "tests/workorder-v2-alpha72-drawing-foundation-contract.mjs",
                  "tests/workorder-v2-alpha72-native-orientation-stabilization-contract.mjs",
                  "tests/workorder-v2-alpha72-drawing-renderer-poc-entry-gate-contract.mjs",
                  "tests/workorder-v2-alpha72-svg-authoring-performance-contract.mjs",
                  "tests/workorder-v2-alpha72-freehand-fidelity-heavy-render-contract.mjs",
                  "tests/workorder-v2-alpha72-finalization-contract.mjs",
                  "tests/workorder-v2-alpha73-product-sketch-persistence-contract.mjs",
                  "tests/workorder-v2-alpha73c-input-sheet-keyboard-normalization-audit-contract.mjs",
                  "tests/workorder-v2-alpha73c-phase1-manual-reusable-create-focus-contract.mjs",
                  "tests/workorder-v2-alpha73c-phase2-shared-focus-lifecycle-normalization-contract.mjs",
                  "tests/workorder-v2-alpha73c-phase3-reveal-geometry-overview-state-integrity-contract.mjs",
                  "tests/workorder-v2-alpha73c-phase4-compact-reveal-keyboard-class-transition-contract.mjs",
                  "tests/workorder-v2-alpha73d-static-sheet-architecture-migration-audit-contract.mjs",
                   "tests/workorder-v2-alpha73d-phase1-static-sheet-primitive-core-contract.mjs",
                  "tests/workorder-v2-alpha73d-phase2-static-keyboard-input-migration-contract.mjs",
                  "tests/workorder-v2-alpha73d-phase2-new-recipe-single-reveal-blocker-contract.mjs",
                  "tests/workorder-v2-alpha73d-phase2-new-recipe-keyboard-appearance-single-reveal-contract.mjs",
                  "tests/workorder-v2-alpha73d-phase3-static-sheet-remaining-surfaces-cleanup-contract.mjs",
                  "tests/workorder-v2-alpha73d-keyboard-reveal-latency-safe-fast-path-contract.mjs",
                  "tests/workorder-v2-alpha73d-cold-start-first-focus-geometry-freshness-contract.mjs",
                  "tests/workorder-v2-alpha73d-cold-start-semantic-scope-registration-replay-contract.mjs",
                  "tests/workorder-v2-alpha73d-compact-semantic-target-formula-under-reveal-contract.mjs",
                  "tests/workorder-v2-alpha73d-spec-save-motion-reference-layout-normalization-contract.mjs",
                  "tests/workorder-v2-alpha73d-root-animation-ownership-direct-create-semantic-target-contract.mjs",
                  "tests/workorder-v2-alpha73d-registered-input-handoff-quick-delivery-numeric-reel-stability-contract.mjs",
                  "tests/workorder-v2-alpha73d-semantic-coordinate-normalization-quick-reveal-numeric-keypad-contract.mjs",
                  "tests/workorder-v2-alpha73d-quick-root-first-reveal-numeric-direct-input-ui-contract.mjs",
                  "tests/workorder-v2-alpha73d-live-body-scroll-numeric-mode-transition-contract.mjs",
                   "tests/workorder-v2-alpha73d-live-root-baseline-residual-scroll-numeric-return-key-contract.mjs",
                   "tests/workorder-v2-alpha73d-nested-keyboard-owner-prepared-recapture-numeric-display-contract.mjs",
                   "tests/workorder-v2-alpha73d-quick-phone-accessory-geometry-contract.mjs",
                  "tests/workorder-v2-alpha73d-quick-phone-return-key-opt-out-contract.mjs",
                  "tests/workorder-v2-alpha73-finalization-contract.mjs",
                  "tests/workorder-v2-alpha74-sketch-responsive-shape-authoring-contract.mjs",
                  "tests/workorder-v2-alpha74-ipad-sketch-orientation-lifecycle-correction-contract.mjs",
                  "tests/workorder-v2-alpha74-ipad-responsive-detail-subtree-continuity-contract.mjs",
                  "tests/workorder-v2-alpha74-compact-tablet-sketch-portrait-policy-contract.mjs",
                  "tests/workorder-v2-alpha74-ios-fullscreen-orientation-native-prerequisite-contract.mjs",
                  "tests/workorder-v2-alpha74-compact-tablet-zero-rotation-motion-contract.mjs",
                  "tests/workorder-v2-alpha74-ios-compact-native-orientation-mask-contract.mjs",
                   "tests/workorder-v2-alpha74-finalization-contract.mjs",
                    "tests/workorder-v2-alpha75-selection-hit-test-object-eraser-contract.mjs",
                    "tests/workorder-v2-alpha75-eraser-visual-feedback-contract.mjs",
                    "tests/workorder-v2-alpha75-partial-eraser-compact-toolbar-contract.mjs",
                    "tests/workorder-v2-alpha75-overlay-palette-stroke-partial-eraser-contract.mjs",
                    "tests/workorder-v2-alpha75-finalization-contract.mjs",
                    "tests/workorder-v2-alpha76-selection-object-move-contract.mjs",
                    "tests/workorder-v2-alpha76-selection-move-pickup-ux-contract.mjs",
                    "tests/workorder-v2-alpha76-visible-canvas-world-surface-contract.mjs",
                    "tests/workorder-v2-alpha76-sketch-workspace-compact-layout-contract.mjs",
                    "tests/workorder-v2-alpha76-fit-paper-pinch-zoom-pan-contract.mjs",
                    "tests/workorder-v2-alpha76-initial-cover-pinch-reliability-contract.mjs",
                    "tests/workorder-v2-alpha76-native-pinch-tracking-frame-coalescing-contract.mjs",
                    "tests/workorder-v2-alpha76-pinch-clamp-boundary-rebase-contract.mjs",
                    "tests/workorder-v2-alpha76-raw-multitouch-camera-acquisition-contract.mjs",
                    "tests/workorder-v2-alpha76-zoom-percent-hud-contract.mjs",
                    "tests/workorder-v2-alpha76-finalization-contract.mjs",
                    "tests/workorder-v2-alpha77-selection-resize-endpoints-contract.mjs",
                    "tests/workorder-v2-alpha77-finalization-contract.mjs",
                    "tests/workorder-v2-alpha78-sketch-pdf-output-fidelity-contract.mjs",
                    "tests/workorder-v2-alpha78-sketch-frame-world-aspect-correction-contract.mjs",
                    "tests/workorder-v2-alpha78-finalization-contract.mjs",
                     "tests/workorder-v2-alpha79-current-revision-artifact-identity-contract.mjs",
                     "tests/workorder-v2-alpha79-stage1-physical-harness-contract.mjs",
                     "tests/workorder-v2-alpha79-stage2a-failure-retry-r2-cleanup-contract.mjs",
                     "tests/workorder-v2-alpha79-stage2b-missing-corrupt-recovery-contract.mjs",
                     "tests/workorder-v2-alpha79-stage3a-revoke-access-invalidation-contract.mjs",
                     "tests/workorder-v2-alpha79-stage3b-revoked-artifact-purge-deleted-contract.mjs",
                     "tests/workorder-v2-alpha79-finalization-contract.mjs",
                     "tests/workorder-v2-alpha80-stage1-canonical-share-binding-contract.mjs",
                     "tests/workorder-v2-alpha80-stage2-share-expiry-revoke-replacement-contract.mjs",
                     "tests/workorder-v2-alpha80-stage2-current-share-link-actions-contract.mjs",
                     "tests/workorder-v2-alpha80-stage3-public-share-security-isolation-contract.mjs",
                     "tests/workorder-v2-alpha80-finalization-contract.mjs",
                     "apps/mobile/features/work-orders/documents/currentShareLinkActions.ts",
                     "app/api/v2/work-orders/documents/[documentRef]/access-tokens/current/route.ts",
                  "apps/mobile/config/waflNativeOrientationPolicy.js",
                  "apps/mobile/plugins/withWaflNativeOrientationPolicy.js",
                  "lib/domain/drawing/adapters.ts",
                  "lib/domain/drawing/authoring.ts",
                  "lib/domain/drawing/contracts.ts",
                   "lib/domain/drawing/history.ts",
                   "lib/domain/drawing/hitTest.ts",
                  "lib/domain/drawing/eraseFreehand.ts",
                  "lib/domain/drawing/exportProjection.ts",
                  "lib/domain/drawing/freehandPath.ts",
                    "lib/domain/drawing/index.ts",
                    "lib/domain/drawing/selectionHandles.ts",
                  ...
                  "lib/domain/drawing/surfaceLayout.ts",
                  "lib/domain/drawing/translation.ts",
        ...
        @{ Name = "workorder v2 alpha.40 Preview output and action density static contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha40-preview-output-and-action-density-contract.mjs") },
          ...
          @{ Name = "workorder v2 alpha.46 mobile basic-info update contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha46-mobile-basic-info-update-contract.mjs") },
          @{ Name = "workorder v2 alpha.46 command runtime boundary contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha46-command-runtime-boundary-contract.mjs") },
          @{ Name = "workorder v2 alpha.46 unsaved/conflict contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha46-mobile-unsaved-conflict-contract.mjs") },
          @{ Name = "workorder v2 alpha.46 date-only regression contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha46-date-only-regression-contract.mjs") },
          @{ Name = "workorder v2 alpha.47 Tailscale developer auto-connect contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha47-tailscale-developer-auto-connect-contract.mjs") },
          ...
          @{ Name = "workorder v2 alpha.52 mobile work-order list contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-work-order-list-contract.mjs") },
          @{ Name = "workorder v2 alpha.52 mobile overview inline editing contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-overview-inline-editing-contract.mjs") },
          @{ Name = "workorder v2 alpha.52 mobile material inline editing contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-material-inline-editing-contract.mjs") },
          @{ Name = "workorder v2 alpha.52 mobile inline focus contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-inline-focus-contract.mjs") },
          @{ Name = "workorder v2 alpha.52 mobile inline visibility and date picker contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-inline-visibility-date-picker-contract.mjs") },
          @{ Name = "workorder v2 alpha.52 mobile numeric draft contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-numeric-draft-contract.mjs") },
          @{ Name = "workorder v2 alpha.52 mobile QA correction contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha52-mobile-qa-correction-contract.mjs") },
          @{ Name = "workorder v2 alpha.53 mobile behavior characterization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha53-mobile-behavior-characterization-contract.mjs") },
          @{ Name = "workorder v2 alpha.53 mobile application controller contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha53-mobile-application-controller-contract.mjs") },
          @{ Name = "workorder v2 alpha.53 mobile policy contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha53-mobile-policy-contract.mjs") },
          @{ Name = "workorder v2 alpha.53 mobile architecture foundation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha53-mobile-architecture-foundation-contract.mjs") },
          @{ Name = "workorder v2 alpha.54 reel picker model contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha54-reel-picker-model-contract.mjs") },
          @{ Name = "workorder v2 alpha.54 material reel local-draft contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha54-material-reel-draft-contract.mjs") },
          @{ Name = "workorder v2 alpha.54 immediate search contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha54-immediate-search-contract.mjs") },
          @{ Name = "workorder v2 alpha.54 user QA remediation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha54-user-qa-remediation-contract.mjs") },
          ...
          @{ Name = "workorder v2 alpha.64 Maker document R0 E2E contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-maker-document-r0-e2e-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 current Maker runtime superset contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-current-maker-runtime-superset-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 document workbench UI conformity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-document-workbench-ui-conformity-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 document attachments and Quick Delivery contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-document-attachments-quick-delivery-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 picker quantity and address contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-picker-quantity-address-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 in-app Juso address search contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-inapp-juso-address-search-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 shared action picker document UI contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-shared-action-picker-document-ui-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Mobile Design System v2 contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-mobile-design-system-v2-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Design System v2 refinement contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-design-system-v2-refinement-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Design System v2 IA simplification contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-design-system-v2-ia-simplification-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Design System v2 matrix materials switch contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-ds-v2-matrix-materials-switch-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 spec catalog sticky tabs draggable sheets contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-spec-catalog-sticky-sheet-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 real sheet gesture and category Spec Item contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-real-sheet-category-spec-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 physical UI regression remediation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-physical-ui-regression-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 contentFit footer and Size/Color inset contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-contentfit-footer-sizecolor-inset-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 sheet actions and Quick nested address contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-sheet-actions-quick-address-nested-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 staged sheet footer sibling layout contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-sheet-footer-layout-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 shared sheet architecture stability contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-shared-sheet-architecture-stability-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 input sheet UX semantics stability contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-input-sheet-ux-semantics-stability-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 free-settle sheet physics contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-free-settle-sheet-physics-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 keyboard focus and sheet actions contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-keyboard-focus-sheet-actions-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 reusable nested create lifecycle contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-reusable-nested-create-lifecycle-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 reusable create input family contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-reusable-create-input-family-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 sheet TextInput focus contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-sheet-textinput-focus-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Quick read-only address contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-quick-readonly-address-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Finished Spec cell affordance contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-finished-spec-cell-affordance-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 field-block focus reveal contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-field-block-focus-reveal-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Quick nested lifecycle stability contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-quick-nested-lifecycle-stability-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 Quick preview state-aware routing contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-quick-preview-state-aware-routing-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 mobile input architecture consolidation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-mobile-input-architecture-consolidation-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 atomic sheet entrance and table focus contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-atomic-sheet-entrance-table-focus-contract.mjs") },
          @{ Name = "workorder v2 alpha.64 WorkOrder create and table input style contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha64-workorder-create-table-input-style-contract.mjs") },
          ...
          @{ Name = "workorder v2 alpha.67 Nth Reorder E2E contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-nth-reorder-e2e-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 detail entry Reorder post-create image pipeline contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-detail-reorder-image-pipeline-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 issue PDF material delete action UI contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-issue-pdf-material-delete-action-ui-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 PDF generation retry public viewer contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-pdf-generation-retry-public-viewer-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 mobile image asset integrity PDF contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-mobile-image-asset-integrity-pdf-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 viewer share reset clean-base contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-viewer-share-reset-cleanbase-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 post clean-base physical corrections contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-post-cleanbase-physical-corrections-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 native authenticated in-app PDF viewer contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-native-inapp-pdf-viewer-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 document UX share save contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-document-ux-share-save-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 identity pick basic spec readiness public viewer contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-identity-pick-basic-spec-readiness-public-viewer-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 PDF spec pagination viewer touch format contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-pdf-spec-pagination-viewer-touch-format-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 viewer close PDF process picker cleanup contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-viewer-close-pdf-process-picker-cleanup-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 picker action list Reorder UX contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-picker-action-list-reorder-ux-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 final PDF redesign picker reel polish contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-final-pdf-redesign-picker-reel-polish-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 portrait PDF visual fidelity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-portrait-pdf-visual-fidelity-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 portrait PDF mock exact fidelity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-portrait-pdf-mock-exact-fidelity-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 PDF print readability factory quantity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-pdf-print-readability-factory-quantity-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 final PDF monochrome branded Viewer contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-final-pdf-monochrome-branded-viewer-contract.mjs") },
          @{ Name = "workorder v2 alpha.67 unit cost finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha67-unit-cost-finalization-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 draft batch Copy Reorder confirm Preview attachment contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-draft-batch-copy-reorder-confirm-preview-attachment-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 swipe Copy Reorder batch blockers contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-swipe-copy-reorder-batch-blockers-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 source audit runtime root fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-source-audit-runtime-root-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 Reorder order Preview Copy focus polish contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-reorder-order-preview-copy-focus-polish-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 Draft delete Reorder tap created-at UX contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-draft-delete-reorder-tap-created-at-ux-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 common action UX Reorder list numeric polish contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-common-action-ux-reorder-list-numeric-polish-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 confirmation pending lineage partner spec reset contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-confirm-pending-lineage-partner-spec-reset-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 WorkOrder open hydration blocker contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-workorder-open-hydration-blocker-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 basic info picker tab delete blocker contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-basic-info-picker-tab-delete-blocker-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 spec Reorder delete feedback system contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-spec-reorder-delete-feedback-system-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 command draft batch sheet UX contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-command-draft-batch-sheet-ux-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 local authoring spec recipe UX contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-local-authoring-spec-recipe-ux-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 category size spec keyboard fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-category-size-spec-keyboard-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 category detail template rebase keyboard feedback contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-category-detail-template-rebase-keyboard-feedback-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 create sheet keyboard restore blocker parity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-create-sheet-keyboard-restore-blocker-parity-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 Maker terminology keyboard geometry stabilization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-maker-terminology-keyboard-geometry-stabilization-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 text-entry keyboard reveal tuning contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-text-entry-keyboard-reveal-tuning-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 text-entry reveal coordinate fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-text-entry-reveal-coordinate-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 ref measurement physical reveal fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-ref-measurement-physical-reveal-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 direct input keyboard system contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-direct-input-keyboard-system-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 direct input locked session confirm detent contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-direct-input-locked-session-confirm-detent-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 direct input single geometry drag submit fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-direct-input-single-geometry-drag-submit-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 direct input tap persist minimal accessory contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-direct-input-tap-persist-minimal-accessory-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 direct input canonical close footerless blocker contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-direct-input-canonical-close-footerless-blocker-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 close animation ownership race fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-close-animation-ownership-race-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.68 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha68-finalization-contract.mjs") },
          @{ Name = "workorder v2 alpha.69 item-aware Size/POM recommendation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha69-item-size-spec-recommendation-contract.mjs") },
          @{ Name = "workorder v2 alpha.69 target-major standard-spec and staged-replacement contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha69-target-major-standard-spec-staged-replacement-contract.mjs") },
          @{ Name = "workorder v2 alpha.69 standard-spec seed, decision overlay, and blocker contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha69-standard-spec-seed-decision-blocker-contract.mjs") },
          ...
          @{ Name = "workorder v2 alpha.72 Drawing foundation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha72-drawing-foundation-contract.mjs") },
          @{ Name = "workorder v2 alpha.72 native orientation stabilization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha72-native-orientation-stabilization-contract.mjs") },
          @{ Name = "workorder v2 alpha.72 Drawing renderer PoC entry gate contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha72-drawing-renderer-poc-entry-gate-contract.mjs") },
          @{ Name = "workorder v2 alpha.72 SVG authoring performance contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha72-svg-authoring-performance-contract.mjs") },
          @{ Name = "workorder v2 alpha.72 freehand fidelity and Heavy render contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha72-freehand-fidelity-heavy-render-contract.mjs") },
          @{ Name = "workorder v2 alpha.72 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha72-finalization-contract.mjs") },
          @{ Name = "workorder v2 alpha.73 product sketch persistence contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73-product-sketch-persistence-contract.mjs") },
          @{ Name = "workorder v2 alpha.73A-1 sketch close action correction contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73a1-sketch-close-action-correction-contract.mjs") },
          @{ Name = "workorder v2 alpha.73A-2 sketch discard exit contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73a2-sketch-discard-exit-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B Product Sketch apparel annotation tools contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b-product-sketch-apparel-annotation-tools-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B-1 Sketch text input anchor preview contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b1-sketch-text-input-anchor-preview-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B-2 shared input keyboard transition and text caret contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b2-shared-input-keyboard-transition-text-caret-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B-3 shared keyboard visibility reconciliation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b3-shared-keyboard-visibility-reconciliation-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B-4 coordinated direct-input entrance contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b4-coordinated-direct-input-entrance-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B-5 prepared local geometry synchronous keyboard target contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b5-prepared-local-geometry-sync-target-contract.mjs") },
          @{ Name = "workorder v2 alpha.73B-6 didShow micro reconciliation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73b6-didshow-micro-reconciliation-contract.mjs") },
          @{ Name = "workorder v2 alpha.73C input sheet keyboard normalization audit contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73c-input-sheet-keyboard-normalization-audit-contract.mjs") },
          @{ Name = "workorder v2 alpha.73C Phase 1 manual reusable create focus contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73c-phase1-manual-reusable-create-focus-contract.mjs") },
          @{ Name = "workorder v2 alpha.73C Phase 2 shared focus lifecycle normalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73c-phase2-shared-focus-lifecycle-normalization-contract.mjs") },
          @{ Name = "workorder v2 alpha.73C Phase 3 reveal geometry and Overview state integrity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73c-phase3-reveal-geometry-overview-state-integrity-contract.mjs") },
          @{ Name = "workorder v2 alpha.73C Phase 4 compact reveal and keyboard-class transition contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73c-phase4-compact-reveal-keyboard-class-transition-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D static sheet architecture migration audit contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-static-sheet-architecture-migration-audit-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Phase 1 static sheet primitive core contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-phase1-static-sheet-primitive-core-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Phase 2 static keyboard input migration contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-phase2-static-keyboard-input-migration-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Phase 2 New Recipe single reveal blocker contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-phase2-new-recipe-single-reveal-blocker-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Phase 2 New Recipe keyboard appearance single reveal contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-phase2-new-recipe-keyboard-appearance-single-reveal-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Phase 3 static sheet remaining surfaces cleanup contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-phase3-static-sheet-remaining-surfaces-cleanup-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D keyboard reveal latency evidence safe fast-path contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-keyboard-reveal-latency-safe-fast-path-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D cold-start first-focus geometry freshness contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-cold-start-first-focus-geometry-freshness-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D cold-start semantic-scope registration replay contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-cold-start-semantic-scope-registration-replay-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D compact semantic target formula under-reveal contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-compact-semantic-target-formula-under-reveal-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Spec Save motion reference layout normalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-spec-save-motion-reference-layout-normalization-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D New Recipe actual-device final geometry evidence contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-new-recipe-actual-device-final-geometry-evidence-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D keyboard focus ordering and semantic clearance fix contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-keyboard-focus-ordering-semantic-clearance-fix-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D root animation ownership direct-create semantic target contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-root-animation-ownership-direct-create-semantic-target-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D registered input handoff Quick Delivery numeric Reel stability contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-registered-input-handoff-quick-delivery-numeric-reel-stability-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D semantic coordinate normalization Quick reveal numeric keypad contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-semantic-coordinate-normalization-quick-reveal-numeric-keypad-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Quick root-first reveal numeric direct-input UI contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-quick-root-first-reveal-numeric-direct-input-ui-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D live body scroll authority and numeric mode transition contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-live-body-scroll-numeric-mode-transition-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D live root baseline residual scroll numeric return-key contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-live-root-baseline-residual-scroll-numeric-return-key-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D nested keyboard owner prepared recapture numeric display contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-nested-keyboard-owner-prepared-recapture-numeric-display-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Quick phone accessory geometry contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-quick-phone-accessory-geometry-contract.mjs") },
          @{ Name = "workorder v2 alpha.73D Quick phone return-key opt-out contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73d-quick-phone-return-key-opt-out-contract.mjs") },
          @{ Name = "workorder v2 alpha.73 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha73-finalization-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 Sketch responsive shape authoring contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-sketch-responsive-shape-authoring-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 iPad Sketch orientation lifecycle correction contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-ipad-sketch-orientation-lifecycle-correction-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 iPad responsive detail subtree continuity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-ipad-responsive-detail-subtree-continuity-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 compact tablet and Product Sketch portrait policy contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-compact-tablet-sketch-portrait-policy-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 iOS fullscreen orientation native prerequisite contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-ios-fullscreen-orientation-native-prerequisite-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 compact tablet zero rotation motion contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-compact-tablet-zero-rotation-motion-contract.mjs") },
          @{ Name = "workorder v2 alpha.74 iOS compact native orientation mask contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-ios-compact-native-orientation-mask-contract.mjs") },
           @{ Name = "workorder v2 alpha.74 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha74-finalization-contract.mjs") },
            @{ Name = "workorder v2 alpha.75 selection hit-test object delete eraser contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha75-selection-hit-test-object-eraser-contract.mjs") },
            @{ Name = "workorder v2 alpha.75 eraser visual feedback contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha75-eraser-visual-feedback-contract.mjs") },
            @{ Name = "workorder v2 alpha.75 partial eraser compact toolbar contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha75-partial-eraser-compact-toolbar-contract.mjs") },
            @{ Name = "workorder v2 alpha.75 overlay palette stroke partial eraser contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha75-overlay-palette-stroke-partial-eraser-contract.mjs") },
            @{ Name = "workorder v2 alpha.75 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha75-finalization-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 selection object move contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-selection-object-move-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 selection move pickup UX contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-selection-move-pickup-ux-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 visible canvas WORLD surface contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-visible-canvas-world-surface-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 Sketch workspace compact layout contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-sketch-workspace-compact-layout-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 Fit Paper pinch zoom pan contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-fit-paper-pinch-zoom-pan-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 initial Cover pinch reliability contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-initial-cover-pinch-reliability-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 native pinch tracking and frame coalescing contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-native-pinch-tracking-frame-coalescing-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 pinch clamp boundary rebase contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-pinch-clamp-boundary-rebase-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 raw multi-touch Camera acquisition contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-raw-multitouch-camera-acquisition-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 zoom percent HUD contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-zoom-percent-hud-contract.mjs") },
            @{ Name = "workorder v2 alpha.76 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha76-finalization-contract.mjs") },
            @{ Name = "workorder v2 alpha.77 selection resize and endpoint editing contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha77-selection-resize-endpoints-contract.mjs") },
            @{ Name = "workorder v2 alpha.77 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha77-finalization-contract.mjs") },
            @{ Name = "workorder v2 alpha.78 Sketch PDF output fidelity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha78-sketch-pdf-output-fidelity-contract.mjs") },
            @{ Name = "workorder v2 alpha.78 Sketch frame WORLD aspect correction contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha78-sketch-frame-world-aspect-correction-contract.mjs") },
            @{ Name = "workorder v2 alpha.78 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha78-finalization-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 current Revision artifact identity contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-current-revision-artifact-identity-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 Stage 1 physical revision artifact QA harness contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-stage1-physical-harness-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 Stage 2A generation failure retry exact R2 cleanup contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-stage2a-failure-retry-r2-cleanup-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 Stage 2B missing corrupt generated artifact recovery contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-stage2b-missing-corrupt-recovery-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 Stage 3A logical revoke access invalidation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-stage3a-revoke-access-invalidation-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 Stage 3B revoked artifact purge deleted lifecycle contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-stage3b-revoked-artifact-purge-deleted-contract.mjs") },
             @{ Name = "workorder v2 alpha.79 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha79-finalization-contract.mjs") },
              @{ Name = "workorder v2 alpha.80 Stage 1 canonical Share binding contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha80-stage1-canonical-share-binding-contract.mjs") },
              @{ Name = "workorder v2 alpha.80 Stage 2 Share expiry revoke replacement contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha80-stage2-share-expiry-revoke-replacement-contract.mjs") },
              @{ Name = "workorder v2 alpha.80 Stage 2 current Share link actions contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha80-stage2-current-share-link-actions-contract.mjs") },
              @{ Name = "workorder v2 alpha.80 Stage 3 public Share security isolation contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha80-stage3-public-share-security-isolation-contract.mjs") },
              @{ Name = "workorder v2 alpha.80 finalization contract"; Command = "node"; Arguments = @("tests/workorder-v2-alpha80-finalization-contract.mjs") },
...
if ($Profile -eq "automation-infrastructure" -and (GetProjectAppVersion) -in @("2.0.0-alpha.63", "2.0.0-alpha.64") -and (Test-Path (Join-Path $ProjectDir "tests/workorder-v2-alpha64-maker-document-r0-e2e-contract.mjs"))) {
    $allowedMigrationChanges = @(
...
if ($Profile -eq "automation-infrastructure" -and (Test-Path (Join-Path $ProjectDir "tests/workorder-v2-alpha73-product-sketch-persistence-contract.mjs"))) {
